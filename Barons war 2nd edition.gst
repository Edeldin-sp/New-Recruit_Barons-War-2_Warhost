...
<gameSystem id="18e3-b985-9231-8295" name="Barons War 2nd - Expansion (ES)" revision="1" battleScribeVersion="2.03" xmlns="" type="gameSystem" library="true">
  <publications>
  ...
  <profileTypes>
    ...
    <profileType id="117d-3f83-34f2-9ab5" name="Mejoras de Grupo de Mando">
      <characteristicTypes>
        <characteristicType id="7c89-b379-a09c-9dab" name="Efecto"/>
      </characteristicTypes>
    </profileType>
    <profileType id="4a63-9eb9-faac-8817" name="Capacidades inherentes">
      <characteristicTypes>
        <characteristicType id="1997-faf8-6fe9-e619" name="Efecto"/>
      </characteristicTypes>
    </profileType>
    <profileType name="Montura" id="bdca-3fcc-9f84-9e76" hidden="false">
      <characteristicTypes>
        <characteristicType name="Modificador" id="4e4d-ef3e-cc21-857d"/>
        <characteristicType name="Efecto" id="5ad9-e718-b665-3dc8"/>
      </characteristicTypes>
    </profileType>
    <profileType name="Montura" id="3f4e-da68-2a7f-12ed" hidden="false">
      <characteristicTypes>
        <characteristicType name="Name" id="24f7-e0d4-9c72-4cd7"/>
        <characteristicType name="Capacidad" id="7af7-f033-776c-f094"/>
      </characteristicTypes>
    </profileType>
    <profileType name="Capacidad" id="6dce-48d1-461b-e4d2" hidden="false">
      <characteristicTypes>
        <characteristicType name="Efecto" id="7537-0316-be9f-ca83"/>
      </characteristicTypes>
    </profileType>
  </profileTypes>
  <categoryEntries>
    ...
    <categoryEntry name="Facción" id="51de-724e-3e29-3c7a" hidden="false">
      <constraints>
  ...
  <forceEntries>
    <forceEntry id="394a-4b44-0747-7e81" name="Séquito" hidden="false">
      <categoryLinks>
  ...
  <sharedSelectionEntries>
    <selectionEntry id="2c27-d8b4-b598-7a67" name="Arma de mano" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="876e-2532-46a8-3f44" name="Arma de mano" hidden="false" typeId="dcb9-1413-7f76-795d" typeName="Equipo">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00">-</characteristic>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c">-</characteristic>
          </characteristics>
        </profile>
      </profiles>
      <costs>
        <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="0"/>
      </costs>
    </selectionEntry>
    <selectionEntry id="2dd4-5ddb-a520-1a54" name="Hacha de batalla" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="ad40-cda9-b3da-e51b" name="Hacha de batalla" hidden="false" typeId="dcb9-1413-7f76-795d" typeName="Equipo">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00">-</characteristic>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c">
            FILO CORTANTE – Las tiradas de Salvación sufren un penalizador de –1.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
      <costs>
        <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="1"/>
      </costs>
    </selectionEntry>
    <selectionEntry id="ab76-e960-c997-c3c6" name="" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="cbf0-6aac-1086-dc7a" name="Arma improvisada" hidden="false" typeId="dcb9-1413-7f76-795d" typeName="Equipo">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00">
            +1 ATAQUE (incluido)
            </characteristic>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c">
            LENTO – Siempre ataca en último lugar, lo que puede significar que ataquen después de un CONTRAATACAR.
            A DOS MANOS – No se puede equipar un escudo con esta arma.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry id="b5d6-e3f3-2300-d647" name="Lanza" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="4ca6-0277-0414-e7b1" name="Lanza" hidden="false" typeId="dcb9-1413-7f76-795d" typeName="Equipo">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00"/>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c">
            ALCANCE – Al realizar un ataque cuerpo a cuerpo, los Guerreros armados con lanzas generan dados de Ataque cuando se encuentran a 3" de una miniatura enemiga.</characteristic>
          </characteristics>
        </profile>
      </profiles>
      <costs>
    ...
    <selectionEntry id="f544-8bb2-1bc0-a19b" name="Cimitarra" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="d43c-b53f-d4c6-c252" name="Cimitarra" hidden="false" typeId="dcb9-1413-7f76-795d" typeName="Equipo">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00">
            +1 ATAQUE (incluido)
            </characteristic>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c">
            CORTANTE – El objetivo sufre un –1 a sus tiradas de Defensa si no lleva armadura o si viste Armadura Acolchada.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
      <costs>
        <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="2"/>
      </costs>
    </selectionEntry>
    <selectionEntry id="17e5-9956-9cf5-e356" name="Irregular" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="d20a-500d-7c70-4f8a" name="Irregular" hidden="false" typeId="3878-a396-f85a-9d37" typeName="Unidad">
          <characteristics>
            <characteristic name="Movimiento" typeId="54d5-6e63-4eb7-29e1">6</characteristic>
            <characteristic name="Ataque" typeId="5a20-6dd1-7ee3-0092">7</characteristic>
            <characteristic name="Defensa" typeId="f1d0-1c9a-3688-f16c">7</characteristic>
            <characteristic name="Moral" typeId="9ce6-a158-d875-d951">5</characteristic>
            <characteristic name="Acciones" typeId="ad31-1007-03db-17d3">1</characteristic>
          </characteristics>
          <attributes>
            <attribute typeId="4e46-284f-349f-3932" name="New Attribute Type"/>
          </attributes>
          <ModificadorGroups>
            <ModificadorGroup type="and">
              <Modificadors>
                <Modificador type="decrement" value="1" field="5a20-6dd1-7ee3-0092">
                  <conditionGroups>
                ...
                <Modificador type="decrement" value="2" field="5a20-6dd1-7ee3-0092">
                  <conditionGroups>
                    <conditionGroup type="or">
                      <conditions>
                ...
                <Modificador type="increment" value="3" field="54d5-6e63-4eb7-29e1">
                  <conditionGroups>
                    <conditionGroup type="or">
                      <conditions>
                ...
                <Modificador type="decrement" value="2" field="f1d0-1c9a-3688-f16c">
                  <conditions>
                    <condition type="atLeast" value="1" field="selections" scope="parent" childId="b805-5e69-0339-2595" shared="true"/>
                  </conditions>
                </Modificador>
                <Modificador type="decrement" value="1" field="f1d0-1c9a-3688-f16c">
                  <conditionGroups>
                    <conditionGroup type="or">
                      <conditions>
                ...
                <Modificador type="decrement" value="2" field="54d5-6e63-4eb7-29e1">
                  <conditions>
                    <condition type="atLeast" value="1" field="selections" scope="parent" childId="b805-5e69-0339-2595" shared="true"/>
                  </conditions>
                </Modificador>
                <Modificador type="decrement" value="1" field="54d5-6e63-4eb7-29e1">
                  <conditions>
                    <condition type="atLeast" value="1" field="selections" scope="parent" childId="88b7-9c20-da54-3855" shared="true"/>
                  </conditions>
                </Modificador>
    ...
    <selectionEntry id="3d1b-488d-05e7-41a2" name="" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="6996-abf3-c17e-1c7d" name="Chivalry" hidden="false" typeId="4a63-9eb9-faac-8817" typeName="Capacidades inherentes">
          <characteristics>
            <characteristic name="Efecto" typeId="1997-faf8-6fe9-e619">
            El Grupo no necesita realizar un chequeo de Moral para cargar contra Caballeros (o sus equivalentes) si no son el objetivo más cercano.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry id="ec71-1b4d-3c52-99b3" name="Vivir por la espada (inherente)" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="e462-a377-9f48-a78b" name="Vivir por la espada" hidden="false" typeId="4a63-9eb9-faac-8817" typeName="Capacidades inherentes">
          <characteristics>
            <characteristic name="Efecto" typeId="1997-faf8-6fe9-e619">
            Puede repetir un dado de Ataque cuerpo a cuerpo contra Grupos que no sean Caballeros (o sus equivalentes).
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry id="af36-8fa1-e0a6-fac0" name="Regular" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="9dd7-aaa3-f077-316b" name="Regular" hidden="false" typeId="3878-a396-f85a-9d37" typeName="Unidad">
          <characteristics>
            <characteristic name="Movimiento" typeId="54d5-6e63-4eb7-29e1">6</characteristic>
            <characteristic name="Ataque" typeId="5a20-6dd1-7ee3-0092">6+</characteristic>
            <characteristic name="Defensa" typeId="f1d0-1c9a-3688-f16c">7+</characteristic>
            <characteristic name="Moral" typeId="9ce6-a158-d875-d951">4+</characteristic>
            <characteristic name="Acciones" typeId="ad31-1007-03db-17d3">1</characteristic>
          </characteristics>
          <attributes>
            <attribute typeId="4e46-284f-349f-3932" name="New Attribute Type"/>
    ...
    <selectionEntry id="84a7-df1c-60be-53cd" name="Veteran(Tier1)" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="a37a-9e86-1da5-e945" name="Veteran" hidden="false" typeId="3878-a396-f85a-9d37" typeName="Unidad" noindex="false">
          <characteristics>
            <characteristic name="Movimiento" typeId="54d5-6e63-4eb7-29e1">6</characteristic>
            <characteristic name="Ataque" typeId="5a20-6dd1-7ee3-0092">5+</characteristic>
            <characteristic name="Defensa" typeId="f1d0-1c9a-3688-f16c">7+</characteristic>
            <characteristic name="Moral" typeId="9ce6-a158-d875-d951">3+</characteristic>
            <characteristic name="Acciones" typeId="ad31-1007-03db-17d3">1</characteristic>
    ...
    <selectionEntry id="ff1e-51c3-286f-6fa7" name="Espadón" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="1416-2ddc-4424-9a43" name="Espadón" hidden="false" typeId="dcb9-1413-7f76-795d" typeName="Equipo">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00">
            +2 ATAQUE (incluido)
            </characteristic>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c">
            PARADA – +1 a la Salvación en combate cuerpo a cuerpo, o bien Salvación de 9+ en combate cuerpo a cuerpo si no está equipado con escudo.
            LENTO – Siempre ataca después de las armas que no lo sean, lo que puede significar que ataquen después de un CONTRAATACAR.
            A DOS MANOS – No se puede equipar un escudo con esta arma.
            </characteristic>
          </characteristics>
        </profile>
      ...
      <costs>
        <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="3"/>
      </costs>
    </selectionEntry>
    <selectionEntry id="6565-488d-02b6-359e" name="Espada" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="bbf8-e951-6197-618b" name="Espada" hidden="false" typeId="dcb9-1413-7f76-795d" typeName="Equipo">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00">+1 ATAQUE (incluido)</characteristic>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c">
            PARADA – +1 a la Salvación en combate cuerpo a cuerpo, o bien Salvación de 9+ en combate cuerpo a cuerpo si no está equipado con escudo.
            </characteristics>
        </profile>
    ...
    <selectionEntry id="af69-397a-7c02-21c4" name="Maza" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="3d88-124d-5ba8-829c" name="Maza" hidden="false" typeId="dcb9-1413-7f76-795d" typeName="Equipo">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00">
            +1 ATAQUE (incluido)
            </characteristic>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c">
            CONTUNDENTE – No se pueden realizar Salvación contra ataques exitosos realizados con Mazas.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry id="cfbd-566a-6409-6715" name="Knight" hidden="false" collective="false" import="true" type="upgrade">
      <entryLinks>
        ...
        <entryLink id="8028-acd6-3812-efd9" name="Knight Capacidades inherentes" hidden="false" collective="false" import="true" targetId="0e37-2a3e-7531-dbba" type="selectionEntryGroup"/>
    ...
    <selectionEntry type="upgrade" import="true" name="Mail" hidden="false" id="b805-5e69-0339-2595">
      <profiles>
        <profile name="Mail" typeId="dcb9-1413-7f76-795d" typeName="Equipo" hidden="false" id="e717-2f54-ed00-5e55">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00">
            -2" Movimiento (incluido)
            +2 Defensa (incluido)
            </characteristic>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c">
            PESADO – Reduce el Movimiento a la mitad en lugar de a un cuarto al moverse por Terreno Difícil.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Padded armour" hidden="false" id="88b7-9c20-da54-3855">
      <profiles>
        <profile name="Padded armour" typeId="dcb9-1413-7f76-795d" typeName="Equipo" hidden="false" id="5d36-666c-5363-8ab8">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00">
            -1" MOVIMIENTO (Incluido)
            +1 DEFENSA (Incluido)
            </characteristic>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c"/>
          </characteristics>
    ...
    <selectionEntry type="upgrade" import="true" name="Small shield" hidden="false" id="029c-43e5-c095-ab47">
      ...
      <profiles>
        <profile name="Small shield" typeId="dcb9-1413-7f76-795d" typeName="Equipo" hidden="false" id="3791-32b1-4158-0394">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00"/>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c">
            9+ SALVACIÓN
    ...
    <selectionEntry type="upgrade" import="true" name="Medium shield" hidden="false" id="61c1-2978-95e9-fdcd">
      ...
      <profiles>
        <profile name="Medium shield" typeId="dcb9-1413-7f76-795d" typeName="Equipo" hidden="false" id="86b9-a08c-6f72-9604">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00"/>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c">
            8+ SALVACIÓN
    ...
    <selectionEntry type="upgrade" import="true" name="Large shield" hidden="false" id="3a9f-795b-a23a-391d">
      <costs>
        <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="4"/>
      </costs>
      <profiles>
        <profile name="Large shield" typeId="dcb9-1413-7f76-795d" typeName="Equipo" hidden="false" id="1410-e5ec-feef-4102">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00"/>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c">
            7+ SALVACIÓN
    ...
    <selectionEntry type="upgrade" import="true" name="Bill/Polearm" hidden="false" id="22d3-360a-2715-403d">
      <profiles>
        <profile name="Bill/Polearm" typeId="dcb9-1413-7f76-795d" typeName="Equipo" hidden="false" id="465d-eb07-2678-d480">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00">
            +1 ATAQUE (incluido)</characteristic>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c">
            HACHAZO – El objetivo sufre un penalizador de –1 a sus tiradas de Defensa.
            ALCANCE – Al realizar un ataque cuerpo a cuerpo, los Guerreros armados con lanzas generan dados de Ataque cuando se encuentran a 2" de una miniatura en contacto de peana con el enemigo (en lugar de 1")</characteristic>
            A DOS MANOS – No se puede equipar un escudo con esta arma.
            </characteristic>
          </characteristics>
        </profile>
    ...
    <selectionEntry type="upgrade" import="true" name="Caballoman&apos;s pick" hidden="false" id="ae97-c1f3-1324-8d74">
      <profiles>
        <profile name="Caballoman&apos;s pick" typeId="dcb9-1413-7f76-795d" typeName="Equipo" hidden="false" id="3cbb-e39e-f082-de47">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00">
            +1 ATAQUE (incluido)</characteristic>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c">
            MONTADO – Solo puede ser equipado por un Guerrero Montado.
            PERFORANTE – Al cargar, el objetivo no aplica los modificadores de armadura a sus tiradas de Defensa.</characteristic>
          </characteristics>
        </profile>
      </profiles>
      <costs>
    ...
    <selectionEntry type="upgrade" import="true" name="Lanza de caballería" hidden="false" id="feb9-5306-f90f-a593">
      <profiles>
        <profile name="Lanza de caballería" typeId="dcb9-1413-7f76-795d" typeName="Equipo" hidden="false" id="e608-2a09-788e-af3f">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00">
            +2 Ataque (NOT INCL)</characteristic>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c">
            LANZA - un solo uso, se pierde tras la carga.
            PERFORANTE – Al cargar, el objetivo no aplica los modificadores de armadura a sus tiradas de Defensa.
            CHOQUE – Si las Lanzas causan alguna baja, el Grupo objetivo debe superar un chequeo de Moral durante la resolución del combate o quedará Roto.</characteristic>
          </characteristics>
        </profile>
      </profiles>
      <costs>
    ...
    <selectionEntry type="model" import="true" name="Caballo" hidden="false" id="f446-3f49-b681-09e1" subType="Montura">
      <profiles>
        <profile name="Caballo" typeId="bdca-3fcc-9f84-9e76" typeName="Montura" hidden="false" id="a7b8-5745-79a1-a57f">
          <characteristics>
            <characteristic name="Modificador" typeId="4e4d-ef3e-cc21-857d">
            +3" MOVIMIENTO</characteristic>
            <characteristic name="Efecto" typeId="5ad9-e718-b665-3dc8"/>
          </characteristics>
        </profile>
      </profiles>
      <costs>
    ...
    <selectionEntry type="model" import="true" name="Caballo con barda" hidden="false" id="de78-136d-16ff-9cc0" subType="Montura">
      <profiles>
        <profile name="Caballo con barda" typeId="bdca-3fcc-9f84-9e76" typeName="Montura" hidden="false" id="36b2-133c-5f86-f3a2">
          <characteristics>
            <characteristic name="Modificador" typeId="4e4d-ef3e-cc21-857d">
            +3" MOVIMIENTO
            +1 DEFENSA
      ...
      <costs>
        <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="5"/>
      </costs>
    </selectionEntry>
    <selectionEntry type="upgrade" import="true" name="Monturaed knight" hidden="false" id="19fe-cae1-827c-902b">
      <entryLinks>
        ...
        <entryLink import="true" name="Monturas" hidden="false" id="f9ac-819b-3fa4-d2c0" type="selectionEntryGroup" targetId="6c23-04db-99bd-bc86"/>
      </entryLinks>
    </selectionEntry>
    <selectionEntry type="upgrade" import="true" name="Arrollar" hidden="false" id="86c0-bb39-4a6c-ea0c">
      <profiles>
        <profile name="Arrollar" typeId="4a63-9eb9-faac-8817" typeName="Capacidades inherentes" hidden="false" id="7a0b-4e37-7648-deaa">
          <characteristics>
            <characteristic name="Efecto" typeId="1997-faf8-6fe9-e619">
            Si no están fatigados, pueden elegir usar Arrollar. Si lo hacen, obtienen +2 a sus tiradas de Ataque.
            Durante la Resolución del Combate, si el Grupo que usa Arrollar gana el combate, el Grupo derrotado no retrocede. En su lugar, mueve a cada Guerrero atacante directamente hacia adelante (en la línea recta) un número de pulgadas igual a su valor completo de Movimiento.
            La medición se hace desde el Guerrero defensor más alejado de la carga.
            Si este movimiento hace que el grupo entre en contacto de peana con un segundo grupo enemigo, realiza una Acción de ATACAR gratuita inmediata, contando como carga pero quedando Fatigado.
            Se inicia el proceso de combate en el paso 5 de Combate cuerpo a cuerpo (Declarar Reacción).
            Esto no cuenta para su número máximo de Acciones. Si este movimiento saca al Grupo de la mesa, no participa más en el juego pero no se considera destruido, y el enemigo no gana Puntos de Victoria.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry type="upgrade" import="true" name="Respeto (inherente)" hidden="false" id="23ac-809d-3b97-e055">
      <profiles>
        <profile name="" typeId="4a63-9eb9-faac-8817" typeName="Capacidades inherentes" hidden="false" id="ac87-33ee-6638-da29">
          <characteristics>
            <characteristic name="Efecto" typeId="1997-faf8-6fe9-e619">
            Cuando un Grupo aliado realiza un chequeo de Moral (no los de Orden) dentro de 6" de un Grupo con esta Habilidad, tira 2d10 y utiliza el resultado más alto.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry type="upgrade" import="true" name="Lo sento señor (inherente)" hidden="false" id="ed60-3022-214c-d447">
      <profiles>
        <profile name="" typeId="4a63-9eb9-faac-8817" typeName="Capacidades inherentes" hidden="false" id="bd2e-476a-49f9-3eec">
          <characteristics>
            <characteristic name="Efecto" typeId="1997-faf8-6fe9-e619">
            Si está Roto y realiza un chequeo para Reagruparse, ignora un penalizador de Moral adicional si se encuentra dentro de 6" de un Grupo de Mando aliado.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry type="upgrade" import="true" name="Tirador (inherente)" hidden="false" id="08cc-946a-cdd3-d22f">
      <profiles>
        <profile name="Tirador" typeId="4a63-9eb9-faac-8817" typeName="Capacidades inherentes" hidden="false" id="82cb-772c-2e17-07e4">
          <characteristics>
            <characteristic name="Efecto" typeId="1997-faf8-6fe9-e619">
            Puede disparar una Ballesta más de una vez por turno. Si realiza un segundo disparo, siempre cuenta como a Alcance Largo.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry type="upgrade" import="true" name="Fé (inherente)" hidden="false" id="2f32-4147-8e6b-5a77">
      <profiles>
        <profile name="Fé" typeId="4a63-9eb9-faac-8817" typeName="Capacidades inherentes" hidden="false" id="b949-f084-4ae6-13f7">
          <characteristics>
            <characteristic name="Efecto" typeId="1997-faf8-6fe9-e619">
            Ignora 1 de Moral al realizar chequeos de Moral (no de Orden).
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry type="upgrade" import="true" name="Cada domingo (inherente)" hidden="false" id="38c1-cd0f-2528-85f9">
      <profiles>
        <profile name="Cada domingo" typeId="4a63-9eb9-faac-8817" typeName="Capacidades inherentes" hidden="false" id="ca92-8a21-755d-86be">
          <characteristics>
            <characteristic name="Efecto" typeId="1997-faf8-6fe9-e619">
            Puede moverse hasta 3" y disparar con un Arco, incluso si está a Alcance Largo.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry type="upgrade" import="true" name="Comandante (inherente)" hidden="false" id="333d-6137-77bc-eabd">
      <profiles>
        <profile name="Comandante" typeId="4a63-9eb9-faac-8817" typeName="Capacidades inherentes" hidden="false" id="735e-ebe8-f491-0c28">
          <characteristics>
            <characteristic name="Efecto" typeId="1997-faf8-6fe9-e619">
            Solo Héroes.
            Debe unirse a un Grupo antes del despliegue, formando un Grupo de Mando.
            Los Grupos dentro del alcance de Mando y con Línea de Visión a un Comandante aliado pueden usar la Moral del Comandante en lugar de la suya propia al realizar chequeos de Moral.
            Un Comandante puede dirigir una Acción de Mando por turno a un Grupo aliado dentro del alcance de Mando y con Línea de Visión, permitiendo que el Grupo realice una Reacción (no una Acción), siempre que supere un chequeo de Orden.
            Si el Comandante está en contacto de base con un enemigo en Combate Cuerpo a Cuerpo, puede gastar Acciones no utilizadas.
            Cada Acción permite al Comandante añadir un dado extra de Ataque o Defensa en combate cuerpo a cuerpo.
            Se debe elegir un Comandante para liderar tu Escolta, convirtiéndolo en el Líder de la Escolta.
            El Líder de la Escolta puede usar Acciones de Mando para dar Acciones a Grupos aliados dentro del alcance de Mando y con Línea de Visión.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Aguantar (inherente)" hidden="false" id="178a-ef34-3ae4-3dd5">
      <profiles>
        <profile name="Aguantar" typeId="4a63-9eb9-faac-8817" typeName="Capacidades inherentes" hidden="false" id="292f-9038-a1db-561e">
          <characteristics>
            <characteristic name="Efecto" typeId="1997-faf8-6fe9-e619">
            Solo puede ser elegido por Grupos de infantería armados con armas de asta.
            Cuando son Cargados por un Grupo Montado, la infantería puede realizar una Reacción de AGUANTAR.
            El grupo de Caballería no puede elegir ARROLLAR y debe realizar una carga normal.
            El Grupo que ha realizado AGUANTAR puede llevar a cabo un ataque de respuesta, cualquier guerrero eliminado como baja seguirá contribuyendo con dados de Ataque.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Sling" hidden="false" id="b7d9-53b5-9fce-6b80">
      <profiles>
        <profile name="Sling" typeId="dcb9-1413-7f76-795d" typeName="Equipo" hidden="false" id="7935-55a3-ef69-1fc6">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00"/>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c">
            A DISTANCIA – Alcance Largo de 10".
            MOVER Y DISPARAR – Puede moverse 6" y disparar con efecto completo.
            DISPARO RÁPIDO – Si el grupo no se movió, cualquier impacto exitoso genera Ataques adicionales.        
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Javelin" hidden="false" id="49eb-cff2-4bbb-7565">
      <profiles>
        <profile name="Javelin" typeId="dcb9-1413-7f76-795d" typeName="Equipo" hidden="false" id="449d-43f9-2a32-ee1c">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00"/>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c">
            A DISTANCIA – Alcance Largo de 6".
            MOVER Y DISPARAR – Puede moverse 6" y disparar con efecto completo.
            CARRERILLA – Gana +d6" de alcance si el/los Guerreros terminan su Movimiento más cerca del objetivo que su posición original.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Bow" hidden="false" id="3b3b-d2f1-97b5-773d">
      ...
      <profiles>
        <profile name="Bow" typeId="dcb9-1413-7f76-795d" typeName="Equipo" hidden="false" id="e9de-6874-ea64-405f">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00">
            Alcance Largo: -1 a las tiradas de Ataque
            Alcance Corto: sin modificador
            </characteristic>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c">
            A DISTANCIA – Alcance Largo de 206". Alcance Corto 10".
            MOVER Y DISPARAR – Puede moverse 3" y disparar con efecto completo.
            A DOS MANOS – No se puede equipar un escudo con esta arma.
            </characteristic>
          </characteristics>
        </profile>
    ...
    <selectionEntry type="upgrade" import="true" name="Crossbow" hidden="false" id="928d-1768-efa0-999d">
      ...
      <profiles>
        <profile name="Crossbow" typeId="dcb9-1413-7f76-795d" typeName="Equipo" hidden="false" id="a8a1-9779-8ea4-2746">
          <characteristics>
            <characteristic name="Modificador" typeId="af11-6378-a52a-ef00">
            Alcance Largo: sin modificador
            Alcance Corto: +1 a las tiradas de Ataque
</characteristic>
            <characteristic name="Efecto" typeId="d8db-69de-4f02-bd8c">
            A DISTANCIA – Alcance Largo de 206". Alcance Corto 10".
            MOVER Y DISPARAR – Puede moverse 3" y disparar con efecto completo.
            A DOS MANOS – No se puede equipar un escudo con esta arma.
            RECARGAR – Solo puede disparar una vez por turno. No puede Contraatacar ni usar Disparo de Reacción.
            GOLPE CRÍTICO – A corta distancia, los dados de Ataque que obtengan un 0 natural solo pueden ser defendidos por dados de Defensa que obtengan un 0 natural.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry type="upgrade" import="true" name="Estandarte (mejora)" hidden="false" id="bc7d-0edb-b3ed-73f3">
      <profiles>
        <profile name="Estandarte (mejora)" typeId="117d-3f83-34f2-9ab5" typeName="Mejoras de Grupo de Mando" hidden="false" id="3a17-372c-3029-2139">
          <characteristics>
            <characteristic name="Efecto" typeId="7c89-b379-a09c-9dab">
            ESTANDARTE – El alcance de Mando del Comandante se extiende a 12", medido desde el portador de la bandera.
            INSPIRAR – Cualquier Grupo aliado dentro de 12" del Estandarte (incluido el Grupo de Mando, pero no su Comandante) puede obtener un dado de Ataque o Defensa gratuito en cada Acción de Combate.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
      <costs>
        <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="9"/>
      </costs>
    </selectionEntry>
    <selectionEntry type="upgrade" import="true" name="Pendón (mejora)" hidden="false" id="a1e0-eca9-cd62-da0e">
      <profiles>
        <profile name="Pendón (mejora)" typeId="117d-3f83-34f2-9ab5" typeName="Mejoras de Grupo de Mando" hidden="false" id="5c58-ea10-5cfa-0f80">
          <characteristics>
            <characteristic name="Efecto" typeId="7c89-b379-a09c-9dab">
            PENDÓN – El alcance de Mando del Comandante se extiende a 9", medido desde el portador de la bandera.
            INSPIRAR – Cualquier Grupo aliado dentro de 9" del Pendón (incluido el Grupo de Mando, pero no su Comandante) puede obtener un dado de Ataque o Defensa gratuito en cada Acción de Combate.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
      <costs>
        <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="7"/>
      </costs>
    </selectionEntry>
    <selectionEntry type="upgrade" import="true" name="Músico (mejora)" hidden="false" id="93a2-4deb-7353-1103">
      <profiles>
        <profile name="Músico (mejora)" typeId="117d-3f83-34f2-9ab5" typeName="Mejoras de Grupo de Mando" hidden="false" id="93c4-f889-9730-7a5e">
          <characteristics>
            <characteristic name="Efecto" typeId="7c89-b379-a09c-9dab">
            MÚSICO – Cualquier Grupo aliado dentro del alcance de Mando del Músico tira dos dados para el Chequeo de Orden al usar una Acción de Mando, eligiendo el resultado más alto.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Sacerdote (mejora)" hidden="false" id="c4a2-07e5-7ede-2ff7">
      <costs>
        <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="4"/>
      </costs>
      <profiles>
        <profile name="Sacerdote (mejora)" typeId="117d-3f83-34f2-9ab5" typeName="Mejoras de Grupo de Mando" hidden="false" id="ae66-4112-4b54-19f0">
          <characteristics>
            <characteristic name="Efecto" typeId="7c89-b379-a09c-9dab">
            PRIEST - Any friendly Group(s) within 6" of the Priest (including the Command Group) ignore one Moral Penalty when taking Moral (but not Order) checks.</characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry id="79f3-6040-fe4c-eb2e" name="Green(Tier1)" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="f436-5dc7-63ed-f63e" name="Green(Tier1)" hidden="false" typeId="3878-a396-f85a-9d37" typeName="Unidad">
          <characteristics>
            <characteristic name="Movimiento" typeId="54d5-6e63-4eb7-29e1">6</characteristic>
            <characteristic name="Ataque" typeId="5a20-6dd1-7ee3-0092">8</characteristic>
            <characteristic name="Defensa" typeId="f1d0-1c9a-3688-f16c">7</characteristic>
            <characteristic name="Moral" typeId="9ce6-a158-d875-d951">6</characteristic>
            <characteristic name="Acciones" typeId="ad31-1007-03db-17d3">1</characteristic>
          </characteristics>
          <attributes>
            <attribute typeId="4e46-284f-349f-3932" name="New Attribute Type"/>
    ...
    <selectionEntry type="upgrade" import="true" name="Irregular(Tier2)" hidden="false" id="db87-638e-73ec-ffbf">
      <profiles>
        <profile name="Irregular(Tier2)" typeId="3878-a396-f85a-9d37" typeName="Unidad" hidden="false" id="b2ed-c1e0-356e-e156">
          <characteristics>
            <characteristic name="Movimiento" typeId="54d5-6e63-4eb7-29e1">6</characteristic>
            <characteristic name="Ataque" typeId="5a20-6dd1-7ee3-0092">6</characteristic>
            <characteristic name="Defensa" typeId="f1d0-1c9a-3688-f16c">7</characteristic>
            <characteristic name="Moral" typeId="9ce6-a158-d875-d951">4</characteristic>
            <characteristic name="Acciones" typeId="ad31-1007-03db-17d3">2</characteristic>
          </characteristics>
          <ModificadorGroups>
            <ModificadorGroup type="and">
              <Modificadors>
    ...
    <selectionEntry id="c8fb-faa1-02f5-5db1" name="Regular(Tier2)" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="ed71-d778-57f4-ee41" name="Regular(Tier2)" hidden="false" typeId="3878-a396-f85a-9d37" typeName="Unidad">
          <characteristics>
            <characteristic name="Movimiento" typeId="54d5-6e63-4eb7-29e1">6</characteristic>
            <characteristic name="Ataque" typeId="5a20-6dd1-7ee3-0092">5+</characteristic>
            <characteristic name="Defensa" typeId="f1d0-1c9a-3688-f16c">7+</characteristic>
    ...
    <selectionEntry id="7d77-aae0-08de-c708" name="Veteran(Tier2)" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="cca9-dbbf-bd38-799c" name="Veteran(Tier2)" hidden="false" typeId="3878-a396-f85a-9d37" typeName="Unidad" noindex="false">
          <characteristics>
            <characteristic name="Movimiento" typeId="54d5-6e63-4eb7-29e1">6</characteristic>
            <characteristic name="Ataque" typeId="5a20-6dd1-7ee3-0092">4+</characteristic>
            <characteristic name="Defensa" typeId="f1d0-1c9a-3688-f16c">7+</characteristic>
            <characteristic name="Moral" typeId="9ce6-a158-d875-d951">2+</characteristic>
            <characteristic name="Acciones" typeId="ad31-1007-03db-17d3">2</characteristic>
          </characteristics>
          <attributes>
            <attribute typeId="4e46-284f-349f-3932" name="New Attribute Type"/>
    ...
    <selectionEntry type="upgrade" import="true" name="Irregular(Tier3)" hidden="false" id="f5e6-98a9-325a-b21c">
      <profiles>
        <profile name="Irregular(Tier3)" typeId="3878-a396-f85a-9d37" typeName="Unidad" hidden="false" id="9a72-b8b6-96b9-89ba">
          <characteristics>
            <characteristic name="Movimiento" typeId="54d5-6e63-4eb7-29e1">6</characteristic>
            <characteristic name="Ataque" typeId="5a20-6dd1-7ee3-0092">6</characteristic>
            <characteristic name="Defensa" typeId="f1d0-1c9a-3688-f16c">7</characteristic>
            <characteristic name="Moral" typeId="9ce6-a158-d875-d951">4</characteristic>
            <characteristic name="Acciones" typeId="ad31-1007-03db-17d3">3</characteristic>
          </characteristics>
          <ModificadorGroups>
            <ModificadorGroup type="and">
              <Modificadors>
    ...
    <selectionEntry id="b820-095d-109b-8a26" name="Regular(Tier3)" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="4d28-2d31-bb69-c46f" name="Regular(Tier3)" hidden="false" typeId="3878-a396-f85a-9d37" typeName="Unidad">
          <characteristics>
            <characteristic name="Movimiento" typeId="54d5-6e63-4eb7-29e1">6</characteristic>
            <characteristic name="Ataque" typeId="5a20-6dd1-7ee3-0092">5+</characteristic>
            <characteristic name="Defensa" typeId="f1d0-1c9a-3688-f16c">7+</characteristic>
    ...
    <selectionEntry id="765a-aa49-8ce9-bd95" name="Veteran(Tier3)" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="898e-45d8-542b-511c" name="Veteran(Tier3)" hidden="false" typeId="3878-a396-f85a-9d37" typeName="Unidad" noindex="false">
          <characteristics>
            <characteristic name="Movimiento" typeId="54d5-6e63-4eb7-29e1">6</characteristic>
            <characteristic name="Ataque" typeId="5a20-6dd1-7ee3-0092">4+</characteristic>
            <characteristic name="Defensa" typeId="f1d0-1c9a-3688-f16c">7+</characteristic>
    ...
    <selectionEntry type="upgrade" import="true" name="Feudal european Facción" hidden="false" id="1cf4-0117-8176-16be">
      <profiles>
        <profile name="Feudal european trait" typeId="3f4e-da68-2a7f-12ed" typeName="Facción trait" hidden="false" id="9bad-95ef-0d71-8c89">
          <characteristics>
            <characteristic name="Name" typeId="24f7-e0d4-9c72-4cd7">CABALLERÍA: PRIMERA CARGA</characteristic>
            <characteristic name="Abilitie" typeId="7af7-f033-776c-f094">
            La primera vez en cada partida que un Grupo de Caballeros Montados declara una Carga, obtiene automáticamente la Habilidad Cerrar Filas, siempre que no esté Fatigado y cargue al menos 6".
            </characteristic>
          </characteristics>
        </profile>
        <profile name="Feudal european trait" typeId="3f4e-da68-2a7f-12ed" typeName="Facción trait" hidden="false" id="fcea-951d-4584-9f08">
          <characteristics>
            <characteristic name="Name" typeId="24f7-e0d4-9c72-4cd7">INFANTERÍA: PANTALLA</characteristic>
            <characteristic name="Abilitie" typeId="7af7-f033-776c-f094">
            Cuando un Grupo de Caballeros Montados declara una Carga, puede trazar Línea de Visión a través de un único Grupo aliado de infantería.
            Este Grupo de Infantería debe realizar un Chequeo de Orden: si lo supera, los Caballeros pueden moverse completamente a través de él (se asume que los Guerreros se apartan y luego retoman su posición) y la Infantería recibe un Penalizador de Moral.
            Si el Grupo falla, los Caballeros aún pueden moverse completamente a través de él, pero el Grupo de Infantería sufre 1d3 bajas (y Penalizadores de Moral).
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry type="upgrade" import="true" name="Ataque back" hidden="false" id="adb4-5f95-c930-03cd">
      <profiles>
        <profile name="Ataque back" typeId="6dce-48d1-461b-e4d2" typeName="Abilitie" hidden="false" id="6d9c-0d3e-0a56-0360">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
    ...
    <selectionEntry type="upgrade" import="true" name="Born for war" hidden="false" id="722e-62ad-f4bc-79b7">
      <profiles>
        <profile name="Born for war" typeId="6dce-48d1-461b-e4d2" typeName="Abilitie" hidden="false" id="7dcf-edcb-c667-b685">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Una vez por turno, si el Grupo es Cargado y no tiene una Acción disponible, puede realizar una Reacción gratuita de DEFENDER o de CONTRAATACAR.
            Provoca que el Grupo se vuelva Fatigado en cuanto se declare la Reacción.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Brave" hidden="false" id="7196-e6ee-bb82-e0b0">
      <profiles>
        <profile name="Brave" typeId="6dce-48d1-461b-e4d2" typeName="Abilitie" hidden="false" id="5a5e-7158-5c7e-fb4c">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            El Grupo obtiene +1 a todos los chequeos de Moral (no de Orden).
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Bulwark" hidden="false" id="4ae2-a91a-d742-49b9">
      <profiles>
        <profile name="Bulwark" typeId="6dce-48d1-461b-e4d2" typeName="Abilitie" hidden="false" id="aae6-2766-2e33-9994">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Cuando un Grupo enemigo tenga como objetivo a este Grupo para una Acción de Combate, este puede elegir ganar +1 a las tiradas de Defensa durante el resto de este turno.
            Si lo hace, no podrá usar una Acción de Combate para Cargar ni para realizar un Ataque a Distancia durante el resto de este turno y el siguiente.
            Sí podrá usar Reacciones, incluyendo CONTRA-ATAQUE o CONTRA-DISPARO.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Close ranks" hidden="false" id="289f-eccf-0d3b-7ab3">
      <profiles>
        <profile name="Close ranks" typeId="6dce-48d1-461b-e4d2" typeName="Abilitie" hidden="false" id="0bd7-0c3f-9481-e543">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Solo puede ser elegido por un Grupo de Caballeros Montados. Cuando los Caballeros declaran una Carga contra un Grupo de infantería, siempre que no estén Fatigados y se encuentren al menos a 6" de su objetivo, pueden Cerrar Filas. Inmediatamente antes de que el Defensor declare su Reacción, la infantería objetivo debe realizar un chequeo de Moral. Si lo falla, el Grupo queda Roto y no podrá realizar una Reacción. No se mueve, pero efectuará su Movimiento de Roto alejándose de los Caballeros que cargan durante el paso de Resolución del Combate. Antes de que los Caballeros realicen su movimiento de Carga, verifica la Coherencia y mueve a los Caballeros hasta el contacto de base con un Guerrero usado como referencia para la Coherencia. Los Caballeros cargan directamente hacia adelante hacia su objetivo.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Counter charge " hidden="false" id="a0fd-71ca-4cab-12a8">
      <profiles>
        <profile name="Counter charge " typeId="6dce-48d1-461b-e4d2" typeName="Abilitie" hidden="false" id="27ec-1e83-e404-d535">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Solo puede ser elegido por un grupo Montado. Si es Cargado por caballería enemiga, puede hacer una Reacción de Contra-Carga. Durante el combate, ambos grupos se consideran Cargando:
            - Cada jugador mueve un Guerrero de su grupo hasta contacto de base; luego se mueve el resto emparejando Guerreros con Línea de Visión.
            - Ambos generan dados de Ataque al mismo tiempo, sin reducción por bajas.
            - Se pueden usar armas y habilidades que se activen al cargar.
            No hay Reacción del Defensor; después del paso de Atacante, se pasa a Resolución del Combate.
            El grupo que pierda más bajas pierde el combate, será Obligado a Retroceder y podría necesitar un chequeo de Moral.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Courageous" hidden="false" id="d6c2-f72b-2687-5d88">
      <profiles>
        <profile name="Courageous" typeId="6dce-48d1-461b-e4d2" typeName="Abilitie" hidden="false" id="abd0-5cd2-d46a-bf09">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            El Grupo supera automáticamente los chequeos de Moral en las tiradas de Huida.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Cruel (Héroe)" hidden="false" id="71f5-8ba0-7767-3934">
      <profiles>
        <profile name="Cruel (Héroe)" typeId="6dce-48d1-461b-e4d2" typeName="Abilitie" hidden="false" id="c6a2-4845-9828-0b09">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Solo Héroes.
            Cuando el Comandante realiza Ataques cuerpo a cuerpo, los Guerreros enemigos en contacto de base deben repetir una tirada de Defensa exitosa causada por el pool de Dados de Ataque del Comandante.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Drilled" hidden="false" id="3c00-eaa9-b656-e694">
      <profiles>
        <profile name="Drilled" typeId="6dce-48d1-461b-e4d2" typeName="Abilitie" hidden="false" id="1f66-7460-8b03-0bd5">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Una vez por turno, un Grupo con esta Habilidad puede ser activado y realizar una Acción de Defensa (no una Reacción) como acción gratuita.
            Esto no cuenta para el número total de Acciones que el Grupo puede realizar.
           </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Estratega" hidden="false" id="54a4-d4fe-a86b-2206">
      <profiles>
        <profile name="Estratega (Líder)" typeId="6dce-48d1-461b-e4d2" typeName="Abilitie" hidden="false" id="0112-1cf9-22f3-6a59">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Solo Líderes
            Al determinar la Iniciativa, el Líder de la Escolta tira un d10 adicional (sin gastar una Acción de Mando) siempre que su Grupo de Mando no tenga Penalizadores de Moral.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Faithful" hidden="false" id="2be5-5ae8-ce8f-a23e">
      <profiles>
        <profile name="Faithful" typeId="6dce-48d1-461b-e4d2" typeName="Abilitie" hidden="false" id="3d1f-b0ab-e016-c14d">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            El Grupo se considera que tiene una Salvación de 9 o 0 si no está equipado con un Escudo.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Fear" hidden="false" id="886c-2ed5-42e4-052d">
      <profiles>
        <profile name="Fear" typeId="6dce-48d1-461b-e4d2" typeName="Abilitie" hidden="false" id="10e8-02a6-1118-c31b">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Los oponentes deben superar un chequeo de Moral para Cargar contra este Grupo.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Follow me" hidden="false" id="bf9f-4220-9243-c38f">
      <profiles>
        <profile name="Follow me" typeId="6dce-48d1-461b-e4d2" typeName="Abilitie" hidden="false" id="77fc-6dd6-8630-534e">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Una vez por turno, cuando este Grupo se activa para una Acción de Movimiento, un único Grupo aliado dentro de 6" también puede ser activado para realizar una Acción de Movimiento gratuita.
            Esta Acción gratuita cuenta para el número máximo de Acciones del Grupo.
            Ambos Grupos deben finalizar su movimiento dentro de 6" uno del otro.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Formidable (Héroe)" hidden="false" id="0da8-b0c2-8c82-86e7">
      <profiles>
        <profile name="Formidable (Héroe)" typeId="6dce-48d1-461b-e4d2" typeName="Abilitie" hidden="false" id="43f7-bbe6-a1a8-2c61">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Solo Héroes.
            Ignora la primera baja exitosa sufrida por el Grupo de Mando de este Héroe.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Glory seekers" hidden="false" id="64bd-fb83-76c5-a878">
      <profiles>
        <profile name="Glory seekers" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="d27b-7f12-5fb9-91a9">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Ignora los efectos negativos de los Penalizadores de Moral en Combate Cuerpo a Cuerpo.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Gutter thug" hidden="false" id="fd96-6e28-f481-c0a5">
      <profiles>
        <profile name="Gutter thug" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="4a88-e2d6-7b80-7123">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Cada ataque defendido con éxito en combate cuerpo a cuerpo genera un Ataque adicional.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Holy relic" hidden="false" id="fb46-8f74-4034-c547">
      ...
      <profiles>
        <profile name="Holy relic" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="bf06-ff2f-a635-0ee8">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Cuando el Grupo elimina Moral en la fase de Mantenimiento, elimina  1 adicional.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry type="upgrade" import="true" name="Líder Inspirador (Héroe)" hidden="false" id="2be2-097f-f079-c118">
      <profiles>
        <profile name="Líder Inspirador (Héroe)" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="8ea7-6fce-3ed5-8db9">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Solo Héroes.
            Todos los Guerreros aliados que tengan LDT a este Héroe obtienen +1 a los chequeos de Moral.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Master fletcher" hidden="false" id="d94a-7760-65b5-a284">
      <profiles>
        <profile name="Master fletcher" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="8f42-d8e8-106c-97b6">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Estos Guerreros aumentan el Alcance Largo en 5" de Arcos y Ballestas.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Measured shot" hidden="false" id="2a9a-9da5-fdb3-1448">
      <profiles>
        <profile name="Measured shot" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="ce42-8b63-59c4-5419">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Cuando el Grupo realiza una Acción de Disparo, obtiene 1 dado de Ataque siempre que el Grupo no se mueva.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Nimble" hidden="false" id="7510-278b-1d3e-8c80">
      <profiles>
        <profile name="Nimble" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="739b-8666-2787-ff4e">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Solo puede ser elegido por grupos que no estén equipados con armadura.
            El Grupo trata el Terreno Difícil como Transitable y el Terreno Muy Difícil como Difícil. Además, el Grupo puede Nadar en Ríos Profundos y Lagos.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Old soldiers" hidden="false" id="0b06-730e-c282-723c">
      <profiles>
        <profile name="Old soldiers" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="39ba-8369-e7df-3b7a">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            La primera vez que el Grupo es Cargado en Combate Cuerpo a Cuerpo cada turno, puede realizar una Reacción de CONTRAATACAR gratuita.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Open up" hidden="false" id="3d84-131f-6c44-be0f">
      ...
      <profiles>
        <profile name="Open up" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="67b5-249a-e926-a8f0">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Los oponentes no reciben ningún bono por realizar una Acción o una Reacción de DEFENDER en Combate Cuerpo a Cuerpo.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Rage" hidden="false" id="5f4a-aa91-267b-e374">
      ...
      <profiles>
        <profile name="Rage" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="33bb-7a08-4b8e-6e54">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Si el Grupo realiza un CONTRAATACAR en Combate Cuerpo a Cuerpo, los Guerreros eliminados como bajas por el ataque inicial siguen contribuyendo con dados de Ataque.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Raise shields" hidden="false" id="2554-9ecc-84dc-ed2a">
      ...
      <profiles>
        <profile name="Raise shields" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="bd9d-b086-2ac3-9269">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Cuando el Grupo realiza una Acción o Reacción de DEFENDER, obtiene +2 a su Salvación así como a la Defensa.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Robust" hidden="false" id="c71e-345e-55fc-a138">
      ...
      <profiles>
        <profile name="Robust" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="639d-31c2-85b8-125e">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Solo Héroes
            Se necesita un impacto exitoso adicional para eliminar a este Comandante como baja.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry type="upgrade" import="true" name="Hostigador" hidden="false" id="d4e8-220e-62c0-19d5">
      <costs>
        <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="2"/>
      </costs>
      <profiles>
        <profile name="Hostigador" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="d25c-2838-31ad-9298">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Solo puede ser elegido por grupos que no estén equipados con armadura.
            El Grupo obtiene +1 a sus tiradas de Defensa contra ataques a Distancia.
            Además, el Grupo puede Nadar en Ríos Profundos y Lagos.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Surefooted" hidden="false" id="27b5-b826-f15c-eb1c">
      <profiles>
        <profile name="Surefooted" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="2faa-0342-0422-0961">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Puede repetir la tirada de los dados de Fuerza de la Carga si el primer resultado provoca que el Grupo falle la Carga.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Cruzado veterano (héroe)" hidden="false" id="565e-5269-c762-318a">
      <costs>
        <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="3"/>
      </costs>
      <profiles>
        <profile name="Cruzado veterano (héroe)" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="0610-e8f9-577a-b2f2">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Solo Héroes
            El Comandante y su Grupo de Mando ignoran sus Penalizadores de Moral al realizar chequeos de Moral.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Weapon choice" hidden="false" id="c6fb-86d6-3577-95fa">
      <profiles>
        <profile name="Weapon choice" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="f934-d924-cbdd-28da">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Solo puede ser elegido por Grupos de infantería armados con Lanzas o Alabardas / Armas de asta.
            Cuando son Cargados por un Grupo Montado, la infantería puede realizar una Reacción de Preparación.
            El Grupo de Caballería no puede elegir Arrollar y debe Cargar normalmente.
            El Grupo Preparado realizará un Contraataque, y cualquier Guerrero eliminado como baja sigue contribuyendo con dados de Ataque.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Brace" hidden="false" id="67ef-023e-1a92-a3ae">
      <profiles>
        <profile name="Brace" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="7964-51d5-ec6c-6bda">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83"></characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry id="62f2-c1dc-6ae1-fd8e" name="Chivalry" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="f0fc-bb02-b090-fe40" name="Chivalry" hidden="false" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">The Group does not need to take a Moral check to charge Knights (or equivalent Warriors deemed to be knights) if they are not the closest target.</characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry type="upgrade" import="true" name="Domingo de sangre" hidden="false" id="36fc-f5b9-b5fa-3368">
      <profiles>
        <profile name="Domingo de sangre" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="2964-140d-79d2-018a">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Puede moverse hasta 3" y disparar con un Arco, incluso si está a Larga distancia.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Faith" hidden="false" id="d06b-3ff8-d5b0-de38">
      <profiles>
        <profile name="Faith" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="462c-84c4-44a4-730e">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Ignora 1 de Moral al realizar chequeos de Moral (no de Orden).
            </characteristic>
    ...
    <selectionEntry id="576c-c58c-4082-1a4d" name="Vivir por la espada" hidden="false" collective="false" import="true" type="upgrade">
      <profiles>
        <profile id="8d9b-e8eb-bed2-1732" name="Vivir por la espada" hidden="false" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Puede repetir un dado de Ataque Cuerpo a Cuerpo contra Grupos que no sean Caballeros (o su equivalente).
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Marksman" hidden="false" id="2e4b-6660-1f70-5d04">
      <profiles>
        <profile name="Marksman" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="3372-e698-bd16-1420">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Puede disparar una Ballesta más de una vez por turno. Si realiza un segundo disparo, siempre cuenta como a Alcance Largo.
            </characteristic>
    ...
    <selectionEntry type="upgrade" import="true" name="Respeto" hidden="false" id="2a36-a92a-89bb-baf6">
      <profiles>
        <profile name="Respeto" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="f89d-1af7-4b9c-9327">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">Cuando un Grupo aliado realiza un chequeo de Moral (no los de Orden) dentro de 6" de un Grupo con esta Habilidad, tira 2d10 y utiliza el resultado más alto.</characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry type="upgrade" import="true" name="Arrollar (caballería)" hidden="false" id="68e0-9ef1-13ab-3c30">
      <profiles>
        <profile name="Arrollar (caballería)" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="28a5-3eb9-4a84-5c53">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">
            Si no están fatigados, pueden elegir usar ARROLLAR. Si lo hacen, obtienen +2 a sus tiradas de Ataque.
            Durante la Resolución del Combate, si el Grupo que usa ARROLLAR gana el combate, el Grupo derrotado no retrocede. En su lugar, mueve a cada Guerrero atacante directamente hacia adelante (en la línea recta) un número de pulgadas igual a su valor completo de Movimiento.
    ...
    <selectionEntry type="upgrade" import="true" name="Lo sento señor" hidden="false" id="0ab1-c9b3-93aa-605b">
      <profiles>
        <profile name="Lo sento señor" typeId="6dce-48d1-461b-e4d2" typeName="Capacidad" hidden="false" id="0c72-a4f7-ca93-8cf1">
          <characteristics>
            <characteristic name="Efecto" typeId="7537-0316-be9f-ca83">Si está Roto y realiza un chequeo para Reagruparse, ignora un penalizador de Moral adicional si se encuentra dentro de 6&quot de un Grupo de Mando aliado..</characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry type="upgrade" import="true" name="Séquito leader" hidden="false" id="f22f-64e5-c004-14b0">
      <constraints>
  ...
  <sharedSelectionEntryGroups>
    <selectionEntryGroup id="0929-995b-24f9-7ced" name="Melee Weapons" hidden="false" collective="false" import="true">
      <entryLinks>
        <entryLink id="0e8f-0741-0b34-1018" name="Arma de mano" hidden="false" collective="false" import="true" targetId="2c27-d8b4-b598-7a67" type="selectionEntry"/>
        <entryLink id="cb18-303c-2ea4-1b29" name="Hacha de batalla" hidden="false" collective="false" import="true" targetId="2dd4-5ddb-a520-1a54" type="selectionEntry"/>
        <entryLink id="3a5b-b672-7bc0-0e8e" name="Cimitarra" hidden="false" collective="false" import="true" targetId="f544-8bb2-1bc0-a19b" type="selectionEntry"/>
        <entryLink id="febb-61a9-d467-7196" name="Arma improvisada" hidden="false" collective="false" import="true" targetId="ab76-e960-c997-c3c6" type="selectionEntry"/>
        <entryLink id="e9aa-c8e4-2792-127b" name="Lanza" hidden="false" collective="false" import="true" targetId="b5d6-e3f3-2300-d647" type="selectionEntry"/>
      </entryLinks>
    </selectionEntryGroup>
    <selectionEntryGroup id="73aa-dacd-a950-9ea2" name="Knight Experience level" hidden="false" collective="false" import="true" defaultSelectionEntryId="e666-8a78-cef7-64ba">
      ...
      <entryLinks>
        <entryLink id="8045-e7b0-49fd-70dc" name="Irregular" hidden="false" collective="true" import="true" targetId="17e5-9956-9cf5-e356" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="12"/>
          </costs>
        </entryLink>
        <entryLink id="e666-8a78-cef7-64ba" name="Regular" hidden="false" collective="true" import="true" targetId="af36-8fa1-e0a6-fac0" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="16"/>
          </costs>
        </entryLink>
        <entryLink id="ab20-2dfd-bd44-c7d0" name="Veteran(Tier1)" hidden="false" collective="true" import="true" targetId="84a7-df1c-60be-53cd" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="19"/>
          </costs>
        </entryLink>
      </entryLinks>
    </selectionEntryGroup>
    <selectionEntryGroup id="orc-war-exp-level" name="Orc Experience level" hidden="false" collective="false" import="true" defaultSelectionEntryId="orc-war-exp-level-g">
      ...
      <entryLinks>
        <entryLink id="orc-war-exp-level-g" name="Green(Tier1)" hidden="false" collective="true" import="true" targetId="79f3-6040-fe4c-eb2e" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="10"/>
          </costs>
        </entryLink>
        <entryLink id="orc-war-exp-level-i" name="Irregular" hidden="false" collective="true" import="true" targetId="17e5-9956-9cf5-e356" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="13"/>
          </costs>
        </entryLink>
        <entryLink id="orc-war-exp-level-r" name="Regular" hidden="false" collective="true" import="true" targetId="af36-8fa1-e0a6-fac0" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="16"/>
          </costs>
        </entryLink>
    ...
    <selectionEntryGroup id="0e37-2a3e-7531-dbba" name="Knight Capacidades inherentes" hidden="false" collective="false" import="true">
      <entryLinks>
        <entryLink id="9ec9-1bc8-de11-40f0" name="Caballería (inherente)" hidden="false" collective="true" import="true" targetId="3d1b-488d-05e7-41a2" type="selectionEntry">
          <constraints>
        ...
        <entryLink id="0fca-07f3-bb63-5db5" name="Vivir por la espada (inherente)" hidden="false" collective="true" import="true" targetId="ec71-1b4d-3c52-99b3" type="selectionEntry">
          <constraints>
          ...
          <Modificadors>
            <Modificador type="set" value="true" field="hidden">
              <conditions>
    ...
    <selectionEntryGroup id="30c4-4c31-7104-9a85" name="Knight Weapon" hidden="false" collective="false" import="true" defaultSelectionEntryId="fa2d-216c-9af3-cab9">
      ...
      <entryLinks>
        <entryLink id="fa2d-216c-9af3-cab9" name="Espada" hidden="false" collective="true" import="true" targetId="6565-488d-02b6-359e" type="selectionEntry" sortIndex="1"/>
        <entryLink id="0afd-eff8-c064-c95f" name="Espadón" hidden="false" collective="true" import="true" targetId="ff1e-51c3-286f-6fa7" type="selectionEntry" sortIndex="4"/>
        <entryLink id="b098-d23e-7bc7-2500" name="Cimitarra" hidden="false" collective="true" import="true" targetId="f544-8bb2-1bc0-a19b" type="selectionEntry" sortIndex="3"/>
        <entryLink id="1196-cc94-78b1-7143" name="Maza" hidden="false" collective="true" import="true" targetId="af69-397a-7c02-21c4" type="selectionEntry" sortIndex="2"/>
      </entryLinks>
    </selectionEntryGroup>
    ...
    <selectionEntryGroup name="Monturas" id="6c23-04db-99bd-bc86" hidden="false" defaultSelectionEntryId="0849-afda-1f13-c534">
      <entryLinks>
        <entryLink import="true" name="Caballo con barda" hidden="false" id="c1b4-48b9-ff08-b732" type="selectionEntry" targetId="de78-136d-16ff-9cc0" collective="true"/>
        <entryLink import="true" name="Caballo" hidden="false" id="0849-afda-1f13-c534" type="selectionEntry" targetId="f446-3f49-b681-09e1" sortIndex="1" collective="true"/>
      </entryLinks>
    </selectionEntryGroup>
    <selectionEntryGroup id="77c8-1fa0-6afd-4590" name="Monturaed knight Capacidades inherentes" hidden="false" collective="false" import="true">
      <entryLinks>
        <entryLink id="54c4-8873-39b5-1716" name="Caballería (inherente)" hidden="false" collective="true" import="true" targetId="3d1b-488d-05e7-41a2" type="selectionEntry">
          <constraints>
        ...
        <entryLink id="0048-d364-5574-5b77" name="Vivir por la espada (inherente)" hidden="false" collective="true" import="true" targetId="ec71-1b4d-3c52-99b3" type="selectionEntry">
          <constraints>
    ...
    <selectionEntryGroup id="10d0-c172-8141-37d4" name="Monturaed Knight Weapon" hidden="false" collective="false" import="true" defaultSelectionEntryId="3c31-146d-3c8d-7491">
      <constraints>
      ...
      <entryLinks>
        <entryLink id="3c31-146d-3c8d-7491" name="Espada" hidden="false" collective="true" import="true" targetId="6565-488d-02b6-359e" type="selectionEntry" sortIndex="1"/>
        <entryLink id="77f5-6f46-48bf-ee8c" name="Cimitarra" hidden="false" collective="true" import="true" targetId="f544-8bb2-1bc0-a19b" type="selectionEntry" sortIndex="3"/>
        <entryLink id="807a-d9e4-76e1-0251" name="Maza" hidden="false" collective="true" import="true" targetId="af69-397a-7c02-21c4" type="selectionEntry" sortIndex="2"/>
        <entryLink import="true" name="Caballoman&apos;s pick" hidden="false" id="a755-0bdf-ee0f-6cab" type="selectionEntry" targetId="ae97-c1f3-1324-8d74" collective="true"/>
      </entryLinks>
    </selectionEntryGroup>
    <selectionEntryGroup id="3578-c8c4-2aba-0350" name="Monturaed knight Experience level" hidden="false" collective="false" import="true" defaultSelectionEntryId="082e-5ac0-e5c9-f19a">
      <constraints>
      ...
      <entryLinks>
        <entryLink id="0423-83c8-84df-5aac" name="Irregular" hidden="false" collective="true" import="true" targetId="17e5-9956-9cf5-e356" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="14"/>
          </costs>
        </entryLink>
        <entryLink id="082e-5ac0-e5c9-f19a" name="Regular" hidden="false" collective="true" import="true" targetId="af36-8fa1-e0a6-fac0" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="18"/>
          </costs>
        </entryLink>
        <entryLink id="2c0d-f46f-a7ba-f738" name="Veteran(Tier1)" hidden="false" collective="true" import="true" targetId="84a7-df1c-60be-53cd" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="21"/>
          </costs>
        </entryLink>
      </entryLinks>
    </selectionEntryGroup>
    <selectionEntryGroup name="Monturaed knight shield" id="0d10-44ee-88c3-8efe" hidden="false" defaultSelectionEntryId="c84b-bf5b-950e-40ca">
      <entryLinks>
    ...
    <selectionEntryGroup name="Monturaed knight may choose weapon" id="26b7-724e-42ec-8075" hidden="false">
      <entryLinks>
        <entryLink import="true" name="Lanza de caballería" hidden="false" id="68ee-fadc-505e-2aac" type="selectionEntry" targetId="feb9-5306-f90f-a593" collective="true"/>
      </entryLinks>
    </selectionEntryGroup>
    <selectionEntryGroup id="c61b-09fe-a5b6-ed19" name="Serjeant Experience level" hidden="false" collective="false" import="true" defaultSelectionEntryId="531f-7bf5-1aef-0a1f">
      ...
      <entryLinks>
        <entryLink id="d0a0-e997-4089-3e15" name="Irregular" hidden="false" collective="true" import="true" targetId="17e5-9956-9cf5-e356" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="12"/>
          </costs>
        </entryLink>
        <entryLink id="531f-7bf5-1aef-0a1f" name="Regular" hidden="false" collective="true" import="true" targetId="af36-8fa1-e0a6-fac0" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="15"/>
          </costs>
        </entryLink>
    ...
    <selectionEntryGroup id="a9fc-4f15-e411-fc2d" name="Serjeant Capacidades inherentes" hidden="false" collective="false" import="true">
      <entryLinks>
        <entryLink import="true" name="Respeto (inherente)" hidden="false" id="f003-0051-7d19-5aea" type="selectionEntry" targetId="23ac-809d-3b97-e055" collective="true">
          <constraints>
    ...
    <selectionEntryGroup id="c699-124d-016a-a277" name="Serjeant Weapon" hidden="false" collective="false" import="true" defaultSelectionEntryId="6380-ecd3-a2bf-d9b4">
      ...
      <entryLinks>
        <entryLink id="6380-ecd3-a2bf-d9b4" name="Espada" hidden="false" collective="true" import="true" targetId="6565-488d-02b6-359e" type="selectionEntry" sortIndex="1">
          <Modificadors>
            <Modificador type="set" value="true" field="hidden">
              <conditions>
        ...
        <entryLink id="1280-d598-32dc-41f5" name="Espadón" hidden="false" collective="true" import="true" targetId="ff1e-51c3-286f-6fa7" type="selectionEntry" sortIndex="4"/>
        <entryLink id="11aa-7505-6dc5-f605" name="Cimitarra" hidden="false" collective="true" import="true" targetId="f544-8bb2-1bc0-a19b" type="selectionEntry" sortIndex="3"/>
        <entryLink id="73ce-753d-dccd-36b7" name="Maza" hidden="false" collective="true" import="true" targetId="af69-397a-7c02-21c4" type="selectionEntry" sortIndex="2"/>
        ...
        <entryLink import="true" name="Lanza" hidden="false" id="8755-c3d3-58ce-8af7" type="selectionEntry" targetId="b5d6-e3f3-2300-d647" collective="true"/>
      </entryLinks>
    </selectionEntryGroup>
    ...
    <selectionEntryGroup id="bb16-e429-0327-4ee3" name="Marksman Serjant Experience level" hidden="false" collective="false" import="true" defaultSelectionEntryId="1768-6b8f-197f-c0f7">
      ...
      <entryLinks>
        <entryLink id="bf55-8541-cd7d-8543" name="Irregular" hidden="false" collective="true" import="true" targetId="17e5-9956-9cf5-e356" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="12"/>
          </costs>
        </entryLink>
        <entryLink id="1768-6b8f-197f-c0f7" name="Regular" hidden="false" collective="true" import="true" targetId="af36-8fa1-e0a6-fac0" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="16"/>
          </costs>
        </entryLink>
    ...
    <selectionEntryGroup id="4867-96cf-03be-f29a" name="Marksman Serjant Capacidades inherentes" hidden="false" collective="false" import="true">
      <entryLinks>
        <entryLink import="true" name="Respeto (inherente)" hidden="false" id="6c42-1ae1-f627-0b27" type="selectionEntry" targetId="23ac-809d-3b97-e055" collective="true">
          <constraints>
    ...
    <selectionEntryGroup name="Monturaed Serjant Armour" id="2476-b61c-7780-b3f6" hidden="false" defaultSelectionEntryId="ce35-0834-8ceb-f780">
      <entryLinks>
    ...
    <selectionEntryGroup name="Monturaed Serjeant shield" id="947c-b574-90a6-75d3" hidden="false" defaultSelectionEntryId="ab1f-20da-703c-b0a5">
      <entryLinks>
    ...
    <selectionEntryGroup id="7e2e-babe-b404-4911" name="Monturaed Serjant Weapon" hidden="false" collective="false" import="true" defaultSelectionEntryId="6380-ecd3-a2bf-d9b4">
      <constraints>
      ...
      <entryLinks>
        <entryLink id="2498-8ee3-e99a-8502" name="Espada" hidden="false" collective="true" import="true" targetId="6565-488d-02b6-359e" type="selectionEntry" sortIndex="1">
          <Modificadors>
            <Modificador type="set" value="true" field="hidden">
              <conditions>
                <condition type="atLeast" value="1" field="selections" scope="parent" childId="17e5-9956-9cf5-e356" shared="true"/>
        ...
        <entryLink id="ae4c-02e0-e614-3042" name="Cimitarra" hidden="false" collective="true" import="true" targetId="f544-8bb2-1bc0-a19b" type="selectionEntry" sortIndex="3"/>
        <entryLink id="2440-1277-ec49-bcf9" name="Maza" hidden="false" collective="true" import="true" targetId="af69-397a-7c02-21c4" type="selectionEntry" sortIndex="2"/>
        <entryLink import="true" name="Lanza" hidden="false" id="6e72-f88f-ff3a-8ee4" type="selectionEntry" targetId="b5d6-e3f3-2300-d647" collective="true"/>
      </entryLinks>
    </selectionEntryGroup>
    <selectionEntryGroup id="ca4c-231a-1d28-6c40" name="Monturaed Serjant Experience level" hidden="false" collective="false" import="true" defaultSelectionEntryId="a776-9408-fcbe-2505">
      <constraints>
      ...
      <entryLinks>
        <entryLink id="af5b-1300-5ed7-978a" name="Irregular" hidden="false" collective="true" import="true" targetId="17e5-9956-9cf5-e356" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="12"/>
          </costs>
        </entryLink>
        <entryLink id="a776-9408-fcbe-2505" name="Regular" hidden="false" collective="true" import="true" targetId="af36-8fa1-e0a6-fac0" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="15"/>
          </costs>
        </entryLink>
    ...
    <selectionEntryGroup id="008e-e028-95ec-26e8" name="Monturaed Serjant Capacidades inherentes" hidden="false" collective="false" import="true">
      <entryLinks>
        <entryLink import="true" name="Respeto (inherente)" hidden="false" id="868c-43bf-3025-862f" type="selectionEntry" targetId="23ac-809d-3b97-e055" collective="true">
          <constraints>
    ...
    <selectionEntryGroup id="602c-b5c6-5507-bcd4" name="Crossbowman Experience level" hidden="false" collective="false" import="true" defaultSelectionEntryId="776d-6ceb-5326-9de2">
      ...
      <entryLinks>
        <entryLink id="9ab5-3bd4-355f-bb44" name="Irregular" hidden="false" collective="true" import="true" targetId="17e5-9956-9cf5-e356" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="11"/>
          </costs>
        </entryLink>
        <entryLink id="776d-6ceb-5326-9de2" name="Regular" hidden="false" collective="true" import="true" targetId="af36-8fa1-e0a6-fac0" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="14"/>
          </costs>
        </entryLink>
        <entryLink id="97e4-6961-d663-d2e8" name="Veteran(Tier1)" hidden="false" collective="true" import="true" targetId="84a7-df1c-60be-53cd" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="17"/>
          </costs>
        </entryLink>
        <entryLink import="true" name="Green(Tier1)" hidden="false" id="b2ea-df46-4af3-18ec" type="selectionEntry" targetId="79f3-6040-fe4c-eb2e" collective="true">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="8"/>
          </costs>
        </entryLink>
      </entryLinks>
    </selectionEntryGroup>
    ...
    <selectionEntryGroup id="0a5a-acd8-e43a-7fc2" name="Bowman Experience level" hidden="false" collective="false" import="true" defaultSelectionEntryId="233f-b82d-7717-ef57">
      ...
      <entryLinks>
        <entryLink id="ee64-f028-421b-bb80" name="Irregular" hidden="false" collective="true" import="true" targetId="17e5-9956-9cf5-e356" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="11"/>
          </costs>
        </entryLink>
        <entryLink id="233f-b82d-7717-ef57" name="Regular" hidden="false" collective="true" import="true" targetId="af36-8fa1-e0a6-fac0" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="15"/>
          </costs>
        </entryLink>
    ...
    <selectionEntryGroup name="Bowman Capacidades inherentes" id="f18f-1221-7c56-27fd" hidden="false">
      <entryLinks>
        <entryLink import="true" name="Domingo de sangre(Inherent)" hidden="false" id="1ef1-8162-f047-0b30" type="selectionEntry" targetId="38c1-cd0f-2528-85f9" collective="true">
          <constraints>
    ...
    <selectionEntryGroup id="d5f2-401f-2d67-cbb2" name="Lanzaman Experience level" hidden="false" collective="false" import="true" defaultSelectionEntryId="0591-efc1-f4e2-16cb">
      <constraints>
      ...
      <entryLinks>
        <entryLink id="5373-c7a8-e873-6961" name="Irregular" hidden="false" collective="true" import="true" targetId="17e5-9956-9cf5-e356" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="11"/>
          </costs>
        </entryLink>
        <entryLink id="0591-efc1-f4e2-16cb" name="Regular" hidden="false" collective="true" import="true" targetId="af36-8fa1-e0a6-fac0" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="15"/>
          </costs>
        </entryLink>
    ...
    <selectionEntryGroup name="Lanzaman Capacidades inherentes" id="49cf-b8c7-c73f-0d8d" hidden="false">
      <entryLinks>
        <entryLink import="true" name="Brace (Inherent)" hidden="false" id="d762-5ad1-d4e6-96ed" type="selectionEntry" targetId="178a-ef34-3ae4-3dd5" collective="true" defaultAMontura="1">
          <constraints>
    ...
    <selectionEntryGroup name="Lanzaman Armour" id="37d9-0f94-aa67-b905" hidden="false" defaultSelectionEntryId="56bd-5da2-a812-a16e">
      <entryLinks>
    ...
    <selectionEntryGroup name="Lanzaman weapon" id="caa5-a3f6-70b1-ce3b" hidden="false">
      <entryLinks>
        <entryLink import="true" name="Lanza" hidden="false" id="f0b8-b987-6cfd-76e8" type="selectionEntry" targetId="b5d6-e3f3-2300-d647" collective="true"/>
    ...
    <selectionEntryGroup name="Lanzaman shield" id="21ae-ca55-502a-fdd1" hidden="false">
      <entryLinks>
    ...
    <selectionEntryGroup id="51e8-3ab2-8338-60be" name="Militant monk Experience level" hidden="false" collective="false" import="true" defaultSelectionEntryId="4553-313a-4b20-205b">
      ...
      <entryLinks>
        <entryLink id="83d3-c5dc-cb36-e032" name="Irregular" hidden="false" collective="true" import="true" targetId="17e5-9956-9cf5-e356" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="12"/>
          </costs>
        </entryLink>
        <entryLink id="4553-313a-4b20-205b" name="Regular" hidden="false" collective="true" import="true" targetId="af36-8fa1-e0a6-fac0" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="15"/>
          </costs>
        </entryLink>
    ...
    <selectionEntryGroup name="Militant monk Capacidades inherentes" id="f7f6-84ce-9c81-32f7" hidden="false">
      <entryLinks>
    ...
    <selectionEntryGroup id="fc31-51a7-6846-c2e3" name="Militant monk Weapon" hidden="false" collective="false" import="true" defaultSelectionEntryId="6380-ecd3-a2bf-d9b4">
      ...
      <entryLinks>
        <entryLink id="4e08-e941-1acf-7549" name="Espada" hidden="false" collective="true" import="true" targetId="6565-488d-02b6-359e" type="selectionEntry" sortIndex="1">
          <Modificadors>
            <Modificador type="set" value="true" field="hidden">
              <conditionGroups>
                <conditionGroup type="or">
        ...
        <entryLink id="1bd4-72f5-758b-d2b0" name="Espadón" hidden="false" collective="true" import="true" targetId="ff1e-51c3-286f-6fa7" type="selectionEntry" sortIndex="4">
          <Modificadors>
            <Modificador type="set" value="true" field="hidden">
              <conditionGroups>
                <conditionGroup type="or">
        ...
        <entryLink import="true" name="Lanza" hidden="false" id="cc39-2a8e-dde4-5b8b" type="selectionEntry" targetId="b5d6-e3f3-2300-d647" collective="true"/>
        <entryLink import="true" name="Arma de mano" hidden="false" id="80cb-45ce-ab5d-fab0" type="selectionEntry" targetId="2c27-d8b4-b598-7a67" collective="true"/>
      </entryLinks>
    </selectionEntryGroup>
    ...
    <selectionEntryGroup id="dbd9-772c-5899-ffcc" name="Levy Experience level" hidden="false" collective="false" import="true" defaultSelectionEntryId="346b-32d3-f8a9-a068">
      ...
      <entryLinks>
        <entryLink id="346b-32d3-f8a9-a068" name="Irregular" hidden="false" collective="true" import="true" targetId="17e5-9956-9cf5-e356" type="selectionEntry">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="12"/>
          </costs>
        </entryLink>
    ...
    <selectionEntryGroup name="Levy inherent abilitie" id="c257-259e-a1be-0d6b" hidden="false">
      <entryLinks>
        <entryLink import="true" name="Lo sento señor (Inherent)" hidden="false" id="4cac-6a3e-438e-d1da" type="selectionEntry" targetId="ed60-3022-214c-d447" collective="true">
          <constraints>
    ...
    <selectionEntryGroup name="Levy weapon" id="3df8-4b9e-b427-5a1c" hidden="false">
      <entryLinks>
        <entryLink import="true" name="Arma de mano" hidden="false" id="a0b5-f4d7-f1f6-041a" type="selectionEntry" targetId="2c27-d8b4-b598-7a67" collective="true" sortIndex="1"/>
        <entryLink import="true" name="Lanza" hidden="false" id="327a-c19e-a695-e9ce" type="selectionEntry" targetId="b5d6-e3f3-2300-d647" collective="true" sortIndex="2"/>
        ...
        <entryLink import="true" name="Arma improvisada" hidden="false" id="9541-60cc-5eae-b460" type="selectionEntry" targetId="ab76-e960-c997-c3c6" collective="true" sortIndex="4"/>
      </entryLinks>
      <constraints>
    ...
    <selectionEntryGroup name="Lord experience level" id="ddae-791b-4bdd-6025" hidden="false" defaultSelectionEntryId="27be-f879-2ee7-733e">
      <entryLinks>
        <entryLink import="true" name="Irregular(Tier2)" hidden="false" id="f2b1-31f7-c133-9b29" type="selectionEntry" targetId="db87-638e-73ec-ffbf">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="26"/>
          </costs>
        </entryLink>
        <entryLink import="true" name="Regular(Tier2)" hidden="false" id="27be-f879-2ee7-733e" type="selectionEntry" targetId="c8fb-faa1-02f5-5db1">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="29"/>
          </costs>
        </entryLink>
        <entryLink import="true" name="Veteran(Tier2)" hidden="false" id="218e-a9e7-2e11-db4e" type="selectionEntry" targetId="7d77-aae0-08de-c708">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="32"/>
          </costs>
        </entryLink>
      </entryLinks>
      <constraints>
    ...
    <selectionEntryGroup name="Lord weapon" id="ac74-952d-5f83-e65c" hidden="false" defaultSelectionEntryId="f79c-bd36-c249-97eb">
      <entryLinks>
        <entryLink import="true" name="Espada" hidden="false" id="f79c-bd36-c249-97eb" type="selectionEntry" targetId="6565-488d-02b6-359e" sortIndex="1"/>
        <entryLink import="true" name="Maza" hidden="false" id="8a5e-76c5-fd75-13fd" type="selectionEntry" targetId="af69-397a-7c02-21c4"/>
        <entryLink import="true" name="Cimitarra" hidden="false" id="7bc6-4c17-aaa0-6083" type="selectionEntry" targetId="f544-8bb2-1bc0-a19b"/>
        <entryLink import="true" name="Espadón" hidden="false" id="cb69-5164-f1c8-89f9" type="selectionEntry" targetId="ff1e-51c3-286f-6fa7"/>
      </entryLinks>
    </selectionEntryGroup>
    ...
    <selectionEntryGroup id="10eb-5d02-bfdf-9de2" name="Lord Capacidades inherentes" hidden="false" collective="false" import="true">
      <entryLinks>
        <entryLink id="076a-8e43-b34e-c496" name="Caballería (inherente)" hidden="false" collective="false" import="true" targetId="3d1b-488d-05e7-41a2" type="selectionEntry">
          <constraints>
        ...
        <entryLink id="a460-5c4e-78a1-5915" name="Vivir por la espada (inherente)" hidden="false" collective="false" import="true" targetId="ec71-1b4d-3c52-99b3" type="selectionEntry">
          <constraints>
    ...
    <selectionEntryGroup id="376c-ad0d-1727-cb7c" name="Monturaed Lord Weapon" hidden="false" collective="false" import="true" defaultSelectionEntryId="9dd0-b84c-ec9e-9ca0">
      <constraints>
      ...
      <entryLinks>
        <entryLink id="9dd0-b84c-ec9e-9ca0" name="Espada" hidden="false" collective="false" import="true" targetId="6565-488d-02b6-359e" type="selectionEntry" sortIndex="1"/>
        <entryLink id="2b75-65ca-cf4e-5cdb" name="Cimitarra" hidden="false" collective="false" import="true" targetId="f544-8bb2-1bc0-a19b" type="selectionEntry" sortIndex="3"/>
        <entryLink id="f6e9-1652-f91f-fc5f" name="Maza" hidden="false" collective="false" import="true" targetId="af69-397a-7c02-21c4" type="selectionEntry" sortIndex="2"/>
        <entryLink import="true" name="Caballoman&apos;s pick" hidden="false" id="3fe0-5191-09b3-de6a" type="selectionEntry" targetId="ae97-c1f3-1324-8d74"/>
      </entryLinks>
    </selectionEntryGroup>
    <selectionEntryGroup name="Monturaed Lord experience level" id="7352-0be1-a3fb-386d" hidden="false" defaultSelectionEntryId="d224-3c35-a6f2-ca9c">
      <entryLinks>
        <entryLink import="true" name="Irregular(Tier2)" hidden="false" id="ab18-dc0b-86cb-7d03" type="selectionEntry" targetId="db87-638e-73ec-ffbf">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="28"/>
          </costs>
        </entryLink>
        <entryLink import="true" name="Regular(Tier2)" hidden="false" id="d224-3c35-a6f2-ca9c" type="selectionEntry" targetId="c8fb-faa1-02f5-5db1">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="31"/>
          </costs>
        </entryLink>
        <entryLink import="true" name="Veteran(Tier2)" hidden="false" id="8c61-ff49-c48a-80ab" type="selectionEntry" targetId="7d77-aae0-08de-c708">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="34"/>
          </costs>
        </entryLink>
      </entryLinks>
      <constraints>
    ...
    <selectionEntryGroup name="Monturaed Lord may choose weapon" id="8f96-4297-0824-5d73" hidden="false">
      <entryLinks>
        <entryLink import="true" name="Lanza de caballería" hidden="false" id="7825-9f89-cd7a-6298" type="selectionEntry" targetId="feb9-5306-f90f-a593"/>
      </entryLinks>
    </selectionEntryGroup>
    <selectionEntryGroup name="Monturaed Lord shield" id="e368-6b1b-a6ac-5613" hidden="false" defaultSelectionEntryId="0edf-5b80-7a83-410e">
      <entryLinks>
    ...
    <selectionEntryGroup id="00a4-17c4-19a5-817a" name="Monturaed Lord Capacidades inherentes" hidden="false" collective="false" import="true">
      <entryLinks>
        <entryLink id="77f0-31ed-abc0-6177" name="Caballería (inherente)" hidden="false" collective="false" import="true" targetId="3d1b-488d-05e7-41a2" type="selectionEntry">
          <constraints>
        ...
        <entryLink id="59a6-dd21-24dc-aa8d" name="Vivir por la espada (inherente)" hidden="false" collective="false" import="true" targetId="ec71-1b4d-3c52-99b3" type="selectionEntry">
          <constraints>
    ...
    <selectionEntryGroup name="Serjeant at arms experience level" id="6ae1-6f8b-fe86-f55d" hidden="false" defaultSelectionEntryId="5b16-dfc4-b7e8-10a1">
      <entryLinks>
        <entryLink import="true" name="Irregular(Tier2)" hidden="false" id="bccf-024d-55e9-371a" type="selectionEntry" targetId="db87-638e-73ec-ffbf">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="25"/>
          </costs>
        </entryLink>
    ...
    <selectionEntryGroup id="2fc5-0399-3eea-bc0d" name="Serjeant at arms Capacidades inherentes" hidden="false" collective="false" import="true">
      <entryLinks>
        <entryLink import="true" name="Respeto (inherente)" hidden="false" id="1f66-5d73-f889-49bb" type="selectionEntry" targetId="23ac-809d-3b97-e055">
          <constraints>
    ...
    <selectionEntryGroup id="1202-8d6b-d5ea-c278" name="Serjeant at arms Weapon" hidden="false" collective="false" import="true" defaultSelectionEntryId="6380-ecd3-a2bf-d9b4">
      ...
      <entryLinks>
        <entryLink id="9692-c8cb-af50-218d" name="Espada" hidden="false" collective="false" import="true" targetId="6565-488d-02b6-359e" type="selectionEntry" sortIndex="2">
          <Modificadors>
            <Modificador type="set" value="true" field="hidden">
              <conditions>
                <condition type="atLeast" value="1" field="selections" scope="parent" childId="17e5-9956-9cf5-e356" shared="true"/>
        ...
        <entryLink id="caf2-41f3-d948-7626" name="Espadón" hidden="false" collective="false" import="true" targetId="ff1e-51c3-286f-6fa7" type="selectionEntry" sortIndex="6"/>
        <entryLink id="14c6-ca72-1542-a262" name="Cimitarra" hidden="false" collective="false" import="true" targetId="f544-8bb2-1bc0-a19b" type="selectionEntry" sortIndex="4"/>
        <entryLink id="821d-909f-8952-68ec" name="Maza" hidden="false" collective="false" import="true" targetId="af69-397a-7c02-21c4" type="selectionEntry" sortIndex="3"/>
        ...
        <entryLink import="true" name="Lanza" hidden="false" id="eed5-6c6c-6c88-5d2d" type="selectionEntry" targetId="b5d6-e3f3-2300-d647" sortIndex="1"/>
      </entryLinks>
    </selectionEntryGroup>
    ...
    <selectionEntryGroup name="Monturaed Serjeant at arms Armour" id="6ce2-7feb-a820-518b" hidden="false" defaultSelectionEntryId="3791-5641-8b12-7c78">
      <entryLinks>
    ...
    <selectionEntryGroup name="Monturaed Serjeant at arms experience level" id="af34-ad06-beb6-8d68" hidden="false" defaultSelectionEntryId="9644-8ca8-c018-c329">
      <entryLinks>
    ...
    <selectionEntryGroup id="3c40-5969-eac5-b9a8" name="Monturaed Serjeant at arms Capacidades inherentes" hidden="false" collective="false" import="true">
      <entryLinks>
        <entryLink import="true" name="Respeto (inherente)" hidden="false" id="6eee-295c-6158-088c" type="selectionEntry" targetId="23ac-809d-3b97-e055">
          <constraints>
    ...
    <selectionEntryGroup name="Monturaed Serjeant at arms shield" id="52a4-ed64-f98a-78e5" hidden="false" defaultSelectionEntryId="6ad2-b8c6-0f72-438e">
      <entryLinks>
    ...
    <selectionEntryGroup id="289d-692a-a758-184e" name="Monturaed Serjeant at arms Weapon" hidden="false" collective="false" import="true" defaultSelectionEntryId="6380-ecd3-a2bf-d9b4">
      <constraints>
      ...
      <entryLinks>
        <entryLink id="3545-24eb-bd25-c768" name="Espada" hidden="false" collective="false" import="true" targetId="6565-488d-02b6-359e" type="selectionEntry" sortIndex="1">
          <Modificadors>
            <Modificador type="set" value="true" field="hidden">
              <conditions>
                <condition type="atLeast" value="1" field="selections" scope="parent" childId="17e5-9956-9cf5-e356" shared="true"/>
        ...
        <entryLink id="0787-e0b2-1314-74ef" name="Cimitarra" hidden="false" collective="false" import="true" targetId="f544-8bb2-1bc0-a19b" type="selectionEntry" sortIndex="3"/>
        <entryLink id="63e7-8dbe-62ac-278e" name="Maza" hidden="false" collective="false" import="true" targetId="af69-397a-7c02-21c4" type="selectionEntry" sortIndex="2"/>
        <entryLink import="true" name="Lanza" hidden="false" id="cad1-0c50-aac6-1ad4" type="selectionEntry" targetId="b5d6-e3f3-2300-d647"/>
      </entryLinks>
    </selectionEntryGroup>
    <selectionEntryGroup name="Baron experience level" id="61a7-8140-e62d-a848" hidden="false" defaultSelectionEntryId="24f1-774f-a1ba-b430">
      <entryLinks>
        <entryLink import="true" name="Irregular(Tier3)" hidden="false" id="2c44-6177-6853-bd0d" type="selectionEntry" targetId="f5e6-98a9-325a-b21c">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="36"/>
          </costs>
        </entryLink>
        <entryLink import="true" name="Regular(Tier3)" hidden="false" id="24f1-774f-a1ba-b430" type="selectionEntry" targetId="b820-095d-109b-8a26">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="39"/>
          </costs>
        </entryLink>
        <entryLink import="true" name="Veteran(Tier3)" hidden="false" id="4d31-4914-45a6-3c0e" type="selectionEntry" targetId="765a-aa49-8ce9-bd95">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="42"/>
          </costs>
        </entryLink>
      </entryLinks>
    </selectionEntryGroup>
    <selectionEntryGroup name="Baron Capacidades inherentes" id="a268-b21a-64f9-38ea" hidden="false">
      <entryLinks>
        <entryLink import="true" name="Caballería (inherente)" hidden="false" id="a2b4-f2a1-dc0f-2b08" type="selectionEntry" targetId="3d1b-488d-05e7-41a2">
          <constraints>
        ...
        <entryLink import="true" name="Vivir por la espada (inherente)" hidden="false" id="9663-c0ea-0243-aac2" type="selectionEntry" targetId="ec71-1b4d-3c52-99b3">
          <constraints>
    ...
    <selectionEntryGroup id="8657-6068-d4c9-215a" name="Baron Weapon" hidden="false" collective="false" import="true" defaultSelectionEntryId="c082-5b51-f196-bee1">
      ...
      <entryLinks>
        <entryLink id="c082-5b51-f196-bee1" name="Espada" hidden="false" collective="false" import="true" targetId="6565-488d-02b6-359e" type="selectionEntry" sortIndex="1"/>
        <entryLink id="309e-2777-8f3c-447d" name="Espadón" hidden="false" collective="false" import="true" targetId="ff1e-51c3-286f-6fa7" type="selectionEntry" sortIndex="4"/>
        <entryLink id="0958-d17e-ff81-5747" name="Cimitarra" hidden="false" collective="false" import="true" targetId="f544-8bb2-1bc0-a19b" type="selectionEntry" sortIndex="3"/>
        <entryLink id="4dde-bf03-358d-ec57" name="Maza" hidden="false" collective="false" import="true" targetId="af69-397a-7c02-21c4" type="selectionEntry" sortIndex="2"/>
      </entryLinks>
    </selectionEntryGroup>
    ...
    <selectionEntryGroup name="Monturaed Baron experience level" id="df5f-611c-e3aa-f548" hidden="false" defaultSelectionEntryId="b1c2-c592-8d7b-b2f9">
      <entryLinks>
        <entryLink import="true" name="Irregular(Tier3)" hidden="false" id="ad53-546a-1b0b-1b78" type="selectionEntry" targetId="f5e6-98a9-325a-b21c">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="38"/>
          </costs>
        </entryLink>
        <entryLink import="true" name="Regular(Tier3)" hidden="false" id="b1c2-c592-8d7b-b2f9" type="selectionEntry" targetId="b820-095d-109b-8a26">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="41"/>
          </costs>
        </entryLink>
        <entryLink import="true" name="Veteran(Tier3)" hidden="false" id="a36e-9554-9a40-a232" type="selectionEntry" targetId="765a-aa49-8ce9-bd95">
          <costs>
            <cost name=" Puntos" typeId="f655-59ab-f98e-f417" value="44"/>
          </costs>
        </entryLink>
      </entryLinks>
    </selectionEntryGroup>
    <selectionEntryGroup name="Monturaed Baron Capacidades inherentes" id="f63d-7e17-941d-d631" hidden="false">
      <entryLinks>
        <entryLink import="true" name="Caballería (inherente)" hidden="false" id="80eb-e165-ebcd-5686" type="selectionEntry" targetId="3d1b-488d-05e7-41a2">
          <constraints>
        ...
        <entryLink import="true" name="Vivir por la espada (inherente)" hidden="false" id="ded6-7fd3-0835-1613" type="selectionEntry" targetId="ec71-1b4d-3c52-99b3">
          <constraints>
    ...
    <selectionEntryGroup name="Monturaed Baron shield" id="d42a-d12f-7e59-d122" hidden="false" defaultSelectionEntryId="4cf9-0571-9d0d-8642">
      <entryLinks>
    ...
    <selectionEntryGroup id="645f-7613-1780-fa65" name="Monturaed Baron Weapon" hidden="false" collective="false" import="true" defaultSelectionEntryId="f137-b03a-27eb-319d">
      <constraints>
      ...
      <entryLinks>
        <entryLink id="f137-b03a-27eb-319d" name="Espada" hidden="false" collective="false" import="true" targetId="6565-488d-02b6-359e" type="selectionEntry" sortIndex="1"/>
        <entryLink id="b6bb-bb30-bc54-7122" name="Cimitarra" hidden="false" collective="false" import="true" targetId="f544-8bb2-1bc0-a19b" type="selectionEntry" sortIndex="3"/>
        <entryLink id="6707-3a50-ee8a-2378" name="Maza" hidden="false" collective="false" import="true" targetId="af69-397a-7c02-21c4" type="selectionEntry" sortIndex="2"/>
        <entryLink import="true" name="Caballoman&apos;s pick" hidden="false" id="a7c2-1062-d64f-6d7c" type="selectionEntry" targetId="ae97-c1f3-1324-8d74"/>
      </entryLinks>
    </selectionEntryGroup>
    <selectionEntryGroup name="Monturaed Baron may choose weapon" id="bcc6-1caf-2490-136e" hidden="false">
      <entryLinks>
        <entryLink import="true" name="Lanza de caballería" hidden="false" id="b46b-0f99-2d8a-549d" type="selectionEntry" targetId="feb9-5306-f90f-a593">
          <constraints>
    ...
    <selectionEntryGroup name="Feudal European abilities" id="c5e4-4e17-d7b1-8c32" hidden="false" collapsible="true" defaultSelectionEntryId="none">
      <entryLinks>
        <entryLink import="true" name="Ataque back" hidden="false" id="f784-5f6e-e32b-d42f" type="selectionEntry" targetId="adb4-5f95-c930-03cd" collective="true">
          <Modificadors>
            <Modificador type="increment" value="2" field="f655-59ab-f98e-f417">
              <repeats>
        ...
        <entryLink import="true" name="Brave" hidden="false" id="57a8-bc91-3ba0-e884" type="selectionEntry" targetId="7196-e6ee-bb82-e0b0" collective="true">
          <Modificadors>
            <Modificador type="increment" value="1" field="f655-59ab-f98e-f417">
              <repeats>
                <repeat value="1" repeats="1" field="selections" scope="parent" childId="model" shared="true" roundUp="false"/>
              </repeats>
            </Modificador>
        ...
        <entryLink import="true" name="Close ranks" hidden="true" id="896f-796d-776e-cf3f" type="selectionEntry" targetId="289f-eccf-0d3b-7ab3" collective="true">
          <Modificadors>
            <Modificador type="set" value="false" field="hidden">
              <conditions>
        ...
        <entryLink import="true" name="Cruel (Héroe)" hidden="true" id="6861-928c-41dc-c064" type="selectionEntry" targetId="71f5-8ba0-7767-3934" collective="true">
          <constraints>
        ...
        <entryLink import="true" name="Estratega" hidden="true" id="b126-4752-9422-acfa" type="selectionEntry" targetId="54a4-d4fe-a86b-2206" collective="true">
          <Modificadors>
            <Modificador type="increment" value="2" field="f655-59ab-f98e-f417">
              <repeats>
                <repeat value="1" repeats="1" field="selections" scope="parent" childId="model" shared="true" roundUp="false"/>
        ...
        <entryLink import="true" name="Formidable (Héroe)" hidden="true" id="bd3e-9872-d3e0-69da" type="selectionEntry" targetId="0da8-b0c2-8c82-86e7" collective="true">
          <constraints>
          ...
          <Modificadors>
            ...
            <Modificador type="increment" value="3" field="f655-59ab-f98e-f417">
              <repeats>
                <repeat value="1" repeats="1" field="selections" scope="parent" childId="model" shared="true" roundUp="false"/>
              </repeats>
            </Modificador>
        ...
        <entryLink import="true" name="Líder Inspirador (Héroe)" hidden="true" id="d08a-8ba1-04de-6c92" type="selectionEntry" targetId="2be2-097f-f079-c118" collective="true">
          <constraints>
        ...
        <entryLink import="true" name="Hostigador" hidden="false" id="4da1-e81d-f0a7-7404" type="selectionEntry" targetId="d4e8-220e-62c0-19d5" collective="true">
          <constraints>
        ...
        <entryLink import="true" name="Cruzado veterano (héroe)" hidden="true" id="4e84-6c64-e76e-55e9" type="selectionEntry" targetId="565e-5269-c762-318a" collective="true">
          <constraints>
      ...
      <Modificadors>
        <Modificador type="increment" value="1" field="c27b-07cd-921a-d036">
          <repeats>
    ...
    <selectionEntryGroup name="Séquito leader" id="6120-a075-6900-f77f" hidden="false">
      <entryLinks>
        <entryLink import="true" name="Séquito leader" hidden="false" id="2239-2e52-dcfe-c107" type="selectionEntry" targetId="f22f-64e5-c004-14b0"/>
      </entryLinks>
    </selectionEntryGroup>
