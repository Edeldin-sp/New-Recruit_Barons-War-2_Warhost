...
<gameSystem id="18e3-b985-9231-8295" name="Barons war 2nd edition" revision="1" battleScribeVersion="2.03" xmlns="http://www.battlescribe.net/schema/gameSystemSchema" type="gameSystem" library="true">
  ...
  <!-- TYPES -->
  <profileTypes>
    <profileType name="Unit" id="3878-a396-f85a-9d37">
      <characteristicTypes>
        <characteristicType name="Movement" id="54d5-6e63-4eb7-29e1"/>
        <characteristicType name="Attack" id="5a20-6dd1-7ee3-0092"/>
        <characteristicType name="Defence" id="f1d0-1c9a-3688-f16c"/>
        <characteristicType name="Morale" id="9ce6-a158-d875-d951"/>
        <characteristicType name="Actions" id="ad31-1007-03db-17d3"/>
      </characteristicTypes>
    </profileType>
    <profileType name="Equipement" id="dcb9-1413-7f76-795d">
      <characteristicTypes>
        <characteristicType id="af11-6378-a52a-ef00" name="Modifier"/>
        <characteristicType id="d8db-69de-4f02-bd8c" name="Effect"/>
      </characteristicTypes>
    </profileType>
    <profileType name="Command group upgrades" id="117d-3f83-34f2-9ab5">
      <characteristicTypes>
        <characteristicType id="7c89-b379-a09c-9dab" name="Effect"/>
      </characteristicTypes>
    </profileType>
    <profileType name="Inherent Abilities" id="4a63-9eb9-faac-8817">
      <characteristicTypes>
  ...
  <!-- CATEGORY -->
  <categoryEntries>
    <categoryEntry name="Warriors (Tier1)" hidden="false" id="31dd-0fdb-79bb-5162"/>
    <categoryEntry name="Lord (Tier2)" hidden="false" id="cd4c-842d-9dc6-02a8"/>
    <categoryEntry name="Baron (Tier3)" hidden="false" id="e069-c059-b935-c3ac"/>
    <categoryEntry name="Faction" hidden="false" id="51de-724e-3e29-3c7a">
      <constraints>
  ...
  <!-- FORCES -->
  <forceEntries>
    <forceEntry name="Retinue" hidden="false" id="394a-4b44-0747-7e81">
      <categoryLinks>
  ...
  <sharedSelectionEntries>
    <!-- MODEL -->
    <selectionEntry type="model" import="true" name="Horse" hidden="false" subType="mount" id="f446-3f49-b681-09e1">
      <profiles>
    ...
    <selectionEntry type="model" import="true" name="Barded Horse" hidden="false" subType="mount" id="de78-136d-16ff-9cc0">
      <profiles>
    ...
    <!-- MEJORAS --> 
    <selectionEntry type="upgrade" import="true" name="Hand Weapon" hidden="false" collective="false" id="2c27-d8b4-b598-7a67">
      <profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Battle Axe" hidden="false" collective="false" id="2dd4-5ddb-a520-1a54">
      <profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="ImprovisedTwo HandedWeapon" hidden="false" collective="false" id="ab76-e960-c997-c3c6">
      <profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Spear" hidden="false" collective="false" id="b5d6-e3f3-2300-d647">
      <profiles>
        <profile id="4ca6-0277-0414-e7b1" name="Spear" hidden="false" typeId="dcb9-1413-7f76-795d" typeName="Equipement">
          <characteristics>
            ...
            <characteristic name="Effect" typeId="d8db-69de-4f02-bd8c">REACH - When making a Melee attack, Warriors armed
              ...
              model in base contact with the enemy (rather than 1&quot;).
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Falchion" hidden="false" collective="false" id="f544-8bb2-1bc0-a19b">
      <profiles>
        <profile id="d43c-b53f-d4c6-c252" name="Falchion" hidden="false" typeId="dcb9-1413-7f76-795d" typeName="Equipement">
          <characteristics>
            ...
            <characteristic name="Effect" typeId="d8db-69de-4f02-bd8c">SLASHING - Target suffers -1 to Defence rolls if
              unarmoured or wearing Padded Armour.
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Irregular(Tier1)" hidden="false" collective="false" id="17e5-9956-9cf5-e356">
      <profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Chivalry (Inherent)" hidden="false" collective="false" id="3d1b-488d-05e7-41a2">
      <profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Live by the sword (Inherent)" hidden="false" collective="false" id="ec71-1b4d-3c52-99b3">
      <profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Regular(Tier1)" hidden="false" collective="false" id="af36-8fa1-e0a6-fac0">
      <profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Veteran(Tier1)" hidden="false" collective="false" id="84a7-df1c-60be-53cd">
      <profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Two handed weapon" hidden="false" collective="false" id="ff1e-51c3-286f-6fa7">
      <profiles>
        <profile id="1416-2ddc-4424-9a43" name="Two handed weapon" hidden="false" typeId="dcb9-1413-7f76-795d" typeName="Equipement">
          <characteristics>
            ...
            <characteristic name="Effect" typeId="d8db-69de-4f02-bd8c">PARRY - Gains +1 to Shield rolls in Melee, or else a 9+Shield roll in Melee if not equipped with a Shield.
              ...
              TWO HANDED - Cannot equip a Shield with this weapon
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Sword" hidden="false" collective="false" id="6565-488d-02b6-359e">
      <profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Mace" hidden="false" collective="false" id="af69-397a-7c02-21c4">
      <profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Knight" hidden="false" collective="false" id="cfbd-566a-6409-6715">
      <entryLinks>
      ...
      <profiles>
        <profile name="Mail" typeId="dcb9-1413-7f76-795d" typeName="Equipement" hidden="false" id="e717-2f54-ed00-5e55">
          <characteristics>
            ...
            <characteristic name="Effect" typeId="d8db-69de-4f02-bd8c">HEAVY - Reduces Movement by half rather than a quarter in Difficult Terrain
            </characteristic>
          </characteristics>
        </profile>
      </profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Green(Tier1)" hidden="false" collective="false" id="79f3-6040-fe4c-eb2e">
      <profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Regular(Tier2)" hidden="false" collective="false" id="c8fb-faa1-02f5-5db1">
      <profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Veteran(Tier2)" hidden="false" collective="false" id="7d77-aae0-08de-c708">
      <profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Regular(Tier3)" hidden="false" collective="false" id="b820-095d-109b-8a26">
      <profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Veteran(Tier3)" hidden="false" collective="false" id="765a-aa49-8ce9-bd95">
      <profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Chivalry" hidden="false" collective="false" id="62f2-c1dc-6ae1-fd8e">
      <profiles>
    ...
    <selectionEntry type="upgrade" import="true" name="Live by the sword" hidden="false" collective="false" id="576c-c58c-4082-1a4d">
      <profiles>
  ...
  <sharedSelectionEntryGroups>
    <selectionEntryGroup name="Melee Weapons" import="true" hidden="false" collective="false" id="0929-995b-24f9-7ced">
      <entryLinks>
    ...
    <selectionEntryGroup name="Knight Experience level" import="true" hidden="false" collective="false" id="73aa-dacd-a950-9ea2" defaultSelectionEntryId="e666-8a78-cef7-64ba">
      <constraints>
    ...
    <selectionEntryGroup name="Knight Inherent Abilities" import="true" hidden="false" collective="false" id="0e37-2a3e-7531-dbba">
      <entryLinks>
    ...
    <selectionEntryGroup name="Knight Weapon" import="true" hidden="false" collective="false" id="30c4-4c31-7104-9a85" defaultSelectionEntryId="fa2d-216c-9af3-cab9">
      <constraints>
    ...
    <selectionEntryGroup name="Knight shield" hidden="false" id="d1c8-2bad-3f64-096c" defaultSelectionEntryId="ab1f-20da-703c-b0a5">
      <entryLinks>
    ...
    <selectionEntryGroup name="Mounts" hidden="false" id="6c23-04db-99bd-bc86" defaultSelectionEntryId="0849-afda-1f13-c534">
      <entryLinks>
    ...
    <selectionEntryGroup name="mounted knight Inherent Abilities" import="true" hidden="false" collective="false" id="77c8-1fa0-6afd-4590">
      <entryLinks>
    ...
    <selectionEntryGroup name="Mounted Knight Weapon" import="true" hidden="false" collective="false" defaultSelectionEntryId="3c31-146d-3c8d-7491" id="10d0-c172-8141-37d4">
      <constraints>
    ...
    <selectionEntryGroup name="Mounted knight Experience level" import="true" hidden="false" collective="false" defaultSelectionEntryId="082e-5ac0-e5c9-f19a" id="3578-c8c4-2aba-0350">
      <constraints>
    ...
    <selectionEntryGroup name="Mounted knight shield" hidden="false" defaultSelectionEntryId="c84b-bf5b-950e-40ca" id="0d10-44ee-88c3-8efe">
      <entryLinks>
    ...
    <selectionEntryGroup name="Serjeant Experience level" import="true" hidden="false" collective="false" id="c61b-09fe-a5b6-ed19" defaultSelectionEntryId="531f-7bf5-1aef-0a1f">
      <constraints>
    ...
    <selectionEntryGroup name="Serjeant Inherent Abilities" import="true" hidden="false" collective="false" id="a9fc-4f15-e411-fc2d">
      <entryLinks>
    ...
    <selectionEntryGroup name="Serjeant Weapon" import="true" hidden="false" collective="false" id="c699-124d-016a-a277" defaultSelectionEntryId="6380-ecd3-a2bf-d9b4">
      <constraints>
    ...
    <selectionEntryGroup name="Serjeant shield" hidden="false" id="a13e-d11f-392a-3c4c" defaultSelectionEntryId="47af-6a09-f91d-b867">
      <entryLinks>
    ...
    <selectionEntryGroup name="Serjeant Armour" hidden="false" id="fcc5-d8cb-8e48-67a9" defaultSelectionEntryId="5a6a-287c-5fc1-21d1">
      <entryLinks>
    ...
    <selectionEntryGroup name="Marksman Serjant Experience level" import="true" hidden="false" collective="false" id="bb16-e429-0327-4ee3" defaultSelectionEntryId="1768-6b8f-197f-c0f7">
      <constraints>
    ...
    <selectionEntryGroup name="Marksman Serjant weapon" hidden="false" id="5c03-90f8-577e-0035" defaultSelectionEntryId="fcd1-d56b-1858-85df">
      <entryLinks>
    ...
    <selectionEntryGroup name="Marksman Serjant Armour" hidden="false" id="2b07-c554-df32-ba7c" defaultSelectionEntryId="56bd-5da2-a812-a16e">
      <entryLinks>
    ...
    <selectionEntryGroup name="Marksman Serjant Inherent Abilities" id="4867-96cf-03be-f29a" import="true" hidden="false" collective="false">
      <entryLinks>
    ...
    <selectionEntryGroup name="Mounted Serjant Armour" hidden="false" id="2476-b61c-7780-b3f6" defaultSelectionEntryId="ce35-0834-8ceb-f780">
      <entryLinks>
    ...
    <selectionEntryGroup name="Mounted Serjeant shield" hidden="false" id="947c-b574-90a6-75d3" defaultSelectionEntryId="ab1f-20da-703c-b0a5">
      <entryLinks>
    ...
    <selectionEntryGroup name="Mounted Serjant Weapon" import="true" id="7e2e-babe-b404-4911" hidden="false" collective="false" defaultSelectionEntryId="6380-ecd3-a2bf-d9b4">
      <constraints>
    ...
    <selectionEntryGroup name="Mounted Serjant Experience level" import="true" hidden="false" collective="false" id="ca4c-231a-1d28-6c40" defaultSelectionEntryId="a776-9408-fcbe-2505">
      <constraints>
    ...
    <selectionEntryGroup name="Mounted Serjant Inherent Abilities" import="true" hidden="false" collective="false" id="008e-e028-95ec-26e8">
      <entryLinks>
    ...
    <selectionEntryGroup name="Crossbowman Experience level" import="true" hidden="false" collective="false" id="602c-b5c6-5507-bcd4" defaultSelectionEntryId="776d-6ceb-5326-9de2">
      <constraints>
    ...
    <selectionEntryGroup name="Crossbowman weapon" hidden="false" id="dbaa-9fe2-76a9-81df" defaultSelectionEntryId="fcd1-d56b-1858-85df">
      <entryLinks>
    ...
    <selectionEntryGroup name="Crossbowman Armour" hidden="false" id="4fb9-f7c5-9a56-3b36" defaultSelectionEntryId="56bd-5da2-a812-a16e">
      <entryLinks>
    ...
    <selectionEntryGroup name="Bowman Experience level" import="true" hidden="false" collective="false" id="0a5a-acd8-e43a-7fc2" defaultSelectionEntryId="233f-b82d-7717-ef57">
      <constraints>
    ...
    <selectionEntryGroup name="Spearman Experience level" hidden="false" collective="false" import="true" id="d5f2-401f-2d67-cbb2" defaultSelectionEntryId="0591-efc1-f4e2-16cb">
      <constraints>
    ...
    <selectionEntryGroup name="Spearman Armour" hidden="false" id="37d9-0f94-aa67-b905" defaultSelectionEntryId="56bd-5da2-a812-a16e">
      <entryLinks>
    ...
    <selectionEntryGroup name="Spearman weapon" hidden="false" id="caa5-a3f6-70b1-ce3b">
      <entryLinks>
    ...
    <selectionEntryGroup name="Spearman shield" hidden="false" id="21ae-ca55-502a-fdd1">
      <entryLinks>
    ...
    <selectionEntryGroup name="Militant monk Experience level" import="true" hidden="false" collective="false" id="51e8-3ab2-8338-60be" defaultSelectionEntryId="4553-313a-4b20-205b">
      <constraints>
    ...
    <selectionEntryGroup name="Militant monk Weapon" import="true" hidden="false" collective="false" id="fc31-51a7-6846-c2e3" defaultSelectionEntryId="6380-ecd3-a2bf-d9b4">
      <constraints>
    ...
    <selectionEntryGroup name="Militant monk shield" hidden="false" id="a8ea-178e-0616-1768">
      <entryLinks>
    ...
    <selectionEntryGroup name="Levy Experience level" import="true" hidden="false" collective="false" id="dbd9-772c-5899-ffcc" defaultSelectionEntryId="346b-32d3-f8a9-a068">
      <constraints>
    ...
    <selectionEntryGroup name="Levy inherent abilitie" hidden="false" id="c257-259e-a1be-0d6b">
      <entryLinks>
    ...
    <selectionEntryGroup name="Levy weapon" hidden="false" id="3df8-4b9e-b427-5a1c">
      <entryLinks>
    ...
    <selectionEntryGroup name="Levy shield" hidden="false" id="5cc9-b06f-44c4-8d85">
      <entryLinks>
    ...
    <selectionEntryGroup name="Tier2 command upgrades" hidden="false" id="2f53-5ca3-4afc-0f22">
      <entryLinks>
    ...
    <selectionEntryGroup name="Lord experience level" hidden="false" id="ddae-791b-4bdd-6025" defaultSelectionEntryId="27be-f879-2ee7-733e">
      <entryLinks>
    ...
    <selectionEntryGroup name="Lord weapon" hidden="false" id="ac74-952d-5f83-e65c" defaultSelectionEntryId="f79c-bd36-c249-97eb">
      <entryLinks>
    ...
    <selectionEntryGroup name="Lord shield" hidden="false" id="bfb3-a695-b7fd-c859" defaultSelectionEntryId="ab1f-20da-703c-b0a5">
      <entryLinks>
    ...
    <selectionEntryGroup name="Lord Inherent Abilities" import="true" hidden="false" collective="false" id="10eb-5d02-bfdf-9de2">
      <entryLinks>
    ...
    <selectionEntryGroup name="Mounted Lord Weapon" import="true" hidden="false" collective="false" id="376c-ad0d-1727-cb7c" defaultSelectionEntryId="9dd0-b84c-ec9e-9ca0">
      <constraints>
    ...
    <selectionEntryGroup name="Mounted Lord experience level" hidden="false" id="7352-0be1-a3fb-386d" defaultSelectionEntryId="d224-3c35-a6f2-ca9c">
      <entryLinks>
    ...
    <selectionEntryGroup name="Mounted Lord may choose weapon" hidden="false" id="8f96-4297-0824-5d73">
      <entryLinks>
        <entryLink import="true" name="Lance" hidden="false" id="7825-9f89-cd7a-6298" type="selectionEntry" targetId="feb9-5306-f90f-a593"/>
      </entryLinks>
    </selectionEntryGroup>
    <selectionEntryGroup name="Mounted Lord shield" hidden="false" id="e368-6b1b-a6ac-5613" defaultSelectionEntryId="0edf-5b80-7a83-410e">
      <entryLinks>
    ...
    <selectionEntryGroup name="Mounted Lord Inherent Abilities" import="true" hidden="false" collective="false" id="00a4-17c4-19a5-817a">
      <entryLinks>
    ...
    <selectionEntryGroup name="Serjeant at arms experience level" hidden="false" id="6ae1-6f8b-fe86-f55d" defaultSelectionEntryId="5b16-dfc4-b7e8-10a1">
      <entryLinks>
    ...
    <selectionEntryGroup name="Serjeant at arms Inherent Abilities" import="true" hidden="false" collective="false" id="2fc5-0399-3eea-bc0d">
      <entryLinks>
    ...
    <selectionEntryGroup name="Serjeant at arms Armour" hidden="false" id="dc8e-1eac-6329-98d4" defaultSelectionEntryId="5a6a-287c-5fc1-21d1">
      <entryLinks>
    ...
    <selectionEntryGroup name="Serjeant at arms Weapon" hidden="false" collective="false" import="true" id="1202-8d6b-d5ea-c278" defaultSelectionEntryId="6380-ecd3-a2bf-d9b4">
      <constraints>
    ...
    <selectionEntryGroup name="Serjeant at arms shield" hidden="false" id="aaa2-218c-8258-4863" defaultSelectionEntryId="ab1f-20da-703c-b0a5">
      <entryLinks>
    ...
    <selectionEntryGroup name="Mounted Serjeant at arms Armour" hidden="false" id="6ce2-7feb-a820-518b" defaultSelectionEntryId="3791-5641-8b12-7c78">
      <entryLinks>
    ...
    <selectionEntryGroup name="Mounted Serjeant at arms experience level" hidden="false" id="af34-ad06-beb6-8d68" defaultSelectionEntryId="9644-8ca8-c018-c329">
      <entryLinks>
    ...
    <selectionEntryGroup name="Mounted Serjeant at arms Inherent Abilities" import="true" hidden="false" collective="false" id="3c40-5969-eac5-b9a8">
      <entryLinks>
    ...
    <selectionEntryGroup name="Mounted Serjeant at arms shield" hidden="false" id="52a4-ed64-f98a-78e5" defaultSelectionEntryId="6ad2-b8c6-0f72-438e">
      <entryLinks>
    ...
    <selectionEntryGroup name="Mounted Serjeant at arms Weapon" import="true" hidden="false" collective="false" id="289d-692a-a758-184e" defaultSelectionEntryId="6380-ecd3-a2bf-d9b4">
      <constraints>
    ...
    <selectionEntryGroup name="Baron experience level" hidden="false" id="61a7-8140-e62d-a848" defaultSelectionEntryId="24f1-774f-a1ba-b430">
      <entryLinks>
    ...
    <selectionEntryGroup name="Baron inherent abilities" hidden="false" id="a268-b21a-64f9-38ea">
      <entryLinks>
    ...
    <selectionEntryGroup name="Baron Weapon" import="true" hidden="false" collective="false" id="8657-6068-d4c9-215a" defaultSelectionEntryId="c082-5b51-f196-bee1">
      <constraints>
    ...
    <selectionEntryGroup name="Baron shield" hidden="false" id="fb81-5bc8-1b37-f332" defaultSelectionEntryId="f446-6acf-a22f-793e">
      <entryLinks>
    ...
    <selectionEntryGroup name="Tier3 command upgrades" hidden="false" id="cf5c-2aa2-9b2c-f23c">
      <entryLinks>
    ...
    <selectionEntryGroup name="Mounted Baron experience level" hidden="false" defaultSelectionEntryId="b1c2-c592-8d7b-b2f9" id="df5f-611c-e3aa-f548">
      <entryLinks>
    ...
    <selectionEntryGroup name="Mounted Baron inherent abilities" hidden="false" id="f63d-7e17-941d-d631">
      <entryLinks>
    ...
    <selectionEntryGroup name="Mounted Baron shield" hidden="false" id="d42a-d12f-7e59-d122" defaultSelectionEntryId="4cf9-0571-9d0d-8642">
      <entryLinks>
    ...
    <selectionEntryGroup name="Mounted Baron Weapon" import="true" hidden="false" collective="false" id="645f-7613-1780-fa65" defaultSelectionEntryId="f137-b03a-27eb-319d">
      <constraints>
    ...
    <selectionEntryGroup name="Mounted Baron may choose weapon" hidden="false" id="bcc6-1caf-2490-136e">
      <entryLinks>
    ...
    <selectionEntryGroup name="Levy extra range weapon" hidden="true" id="85f9-eb71-52d4-f4af">
      <entryLinks>
